...
using TetronJob.Exceptions;

namespace TetronJob.Middlewares
{
    public class CustomExceptionHandlerMiddleware
    {
        ...
        public async Task Invoke(HttpContext context)
        {
            ...
            {
                ModelStateDictionary formError = new ModelStateDictionary();
                formError.AddModelError("", exception.Message);
            }
