...
(function () {
    if (window.CKEDITOR && window.CKEDITOR.dom) return; window.CKEDITOR || (window.CKEDITOR = function () {
        var a = /(^|.*[\\\/])ckeditor\.js(?:\?.*|;.*)?$/i, d = {
            timestamp: "M2G9", version: "4.18.0", revision: "5fe059002f3", rnd: Math.floor(900 * Math.random()) + 100, _: { pending: [], basePathSrcPattern: a }, status: "unloaded", basePath: function () {
        ...
        var a = {}; CKEDITOR.event || (CKEDITOR.event = function () { }, CKEDITOR.event.implementOn = function (a) { var b = CKEDITOR.event.prototype, c; for (c in b) null == a[c] && (a[c] = b[c]) }, CKEDITOR.event.prototype = function () {
            function d(a) { var e = b(this); return e[a] || (e[a] = new c(a)) } var b = function (a) { a = a.getPrivate && a.getPrivate() || a._ || (a._ = {}); return a.events || (a.events = {}) }, c = function (a) { this.name = a; this.listeners = [] }; c.prototype = {
                ...
                define: function (a, b) { var c = d.call(this, a); CKEDITOR.tools.extend(c, b, !0) }, on: function (b, c, k, h, l) {
                    function r(w, y, z, l) { w = { name: b, sender: this, editor: w, data: y, listenerData: h, stop: z, cancel: l, removeListener: g }; return !1 === c.call(k, w) ? a : w.data } function g() { w.removeListener(b, c) } var w = this, y = d.call(this, b); if (0 > y.getListenerIndex(c)) {
                        y = y.listeners; k || (k = this); isNaN(l) && (l = 10); r.fn = c; r.priority = l; for (var z = y.length - 1; 0 <= z; z--)if (y[z].priority <= l) return y.splice(z + 1, 0, r), { removeListener: g };
                        y.unshift(r)
                    } return { removeListener: g }
                }, once: function () { var a = Array.prototype.slice.call(arguments), b = a[1]; a[1] = function (a) { a.removeListener(); return b.apply(this, arguments) }; return this.on.apply(this, a) }, capture: function () { CKEDITOR.event.useCapture = 1; var a = this.on.apply(this, arguments); CKEDITOR.event.useCapture = 0; return a }, fire: function () {
                    var c = 0, e = function () { c = 1 }, d = 0, h = function () { d = 1 }; return function (l, r, g) {
                        var w = b(this)[l]; l = c; var y = d; c = d = 0; if (w) {
                            var z = w.listeners; if (z.length) for (var z = z.slice(0),
                                A, t = 0; t < z.length; t++) { if (w.errorProof) try { A = z[t].call(this, g, r, e, h) } catch (m) { } else A = z[t].call(this, g, r, e, h); A === a ? d = 1 : "undefined" != typeof A && (r = A); if (c || d) break }
                        } r = d ? !1 : "undefined" == typeof r ? !0 : r; c = l; d = y; return r
                    }
    ...
    (function () {
        function a(a, y, b) { this._minInterval = a; this._context = b; this._lastOutput = this._scheduledTimer = 0; this._output = CKEDITOR.tools.bind(y, b || {}); var c = this; this.input = function () { function a() { c._lastOutput = (new Date).getTime(); c._scheduledTimer = 0; c._call() } if (!c._scheduledTimer || !1 !== c._reschedule()) { var w = (new Date).getTime() - c._lastOutput; w < c._minInterval ? c._scheduledTimer = setTimeout(a, c._minInterval - w) : a() } } } function d(w, y, b) {
            a.call(this, w, y, b); this._args = []; var c = this; this.input = CKEDITOR.tools.override(this.input,
                function (a) { return function () { c._args = Array.prototype.slice.call(arguments); a.call(this) } })
        } var b = [], c = CKEDITOR.env.gecko ? "-moz-" : CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "", f = /&/g, e = />/g, k = /</g, h = /"/g, l = /&(lt|gt|amp|quot|nbsp|shy|#\d{1,5});/g, r = { lt: "\x3c", gt: "\x3e", amp: "\x26", quot: '"', nbsp: " ", shy: "­" }, g = function (a, y) { return "#" == y[0] ? String.fromCharCode(parseInt(y.slice(1), 10)) : r[y] }; CKEDITOR.on("reset", function () { b = [] }); CKEDITOR.tools = {
            arrayCompare: function (a, y) {
                ...
                return a
            }, override: function (a, b) { var c = b(a); c.prototype = a.prototype; return c }, setTimeout: function (a, b, c, g, h) { h || (h = window); c || (c = h); return h.setTimeout(function () { g ? a.apply(c, [].concat(g)) : a.apply(c) }, b || 0) }, throttle: function (a, b, c) { return new this.buffers.throttle(a, b, c) }, trim: function () { var a = /(?:^[ \t\n\r]+)|(?:[ \t\n\r]+$)/g; return function (b) { return b.replace(a, "") } }(), ltrim: function () { var a = /^[ \t\n\r]+/g; return function (b) { return b.replace(a, "") } }(), rtrim: function () {
                ...
                c) { return b.push(function () { return a.apply(c || this, arguments) }) - 1 }, removeFunction: function (a) { b[a] = null }, callFunction: function (a) { var c = b[a]; return c && c.apply(window, Array.prototype.slice.call(arguments, 1)) }, cssLength: function () { var a = /^-?\d+\.?\d*px$/, b; return function (c) { b = CKEDITOR.tools.trim(c + "") + "px"; return a.test(b) ? b : c || "" } }(), convertToPx: function () {
                    var a, b; return function (c) {
                        a || (a = CKEDITOR.dom.element.createFromHtml('\x3cdiv style\x3d"position:absolute;left:-9999px;top:-9999px;margin:0px;padding:0px;border:0px;"\x3e\x3c/div\x3e',
                            CKEDITOR.document), CKEDITOR.document.getBody().append(a)); if (!/%$/.test(c)) { var g = 0 > parseFloat(c); g && (c = c.replace("-", "")); a.setStyle("width", c); b = a.getClientRect(); c = Math.round(b.width); return g ? -c : c } return c
                    }
                    ...
                    return function () {
                        var b = arguments,
                        c = this; window.setTimeout(function () { a.apply(c, b) }, 0)
                    }
                    ...
                    return a.replace(/#(([0-9a-f]{3}){1,2})($|;|\s+)/gi,
                        function (a, b, c, g) { a = b.toLowerCase(); 3 == a.length && (a = a.split(""), a = [a[0], a[0], a[1], a[1], a[2], a[2]].join("")); return "#" + a + g })
                }, _isValidColorFormat: function (a) { if (!a) return !1; a = a.replace(/\s+/g, ""); return /^[a-z0-9()#%,./]+$/i.test(a) }, parseCssText: function (a, b, c) {
                    var g = {}; c && (a = (new CKEDITOR.dom.element("span")).setAttribute("style", a).getAttribute("style") || ""); a && (a = CKEDITOR.tools.normalizeHex(CKEDITOR.tools.convertRgbToHex(a))); if (!a || ";" == a) return g; a.replace(/&quot;/g, '"').replace(/\s*([^:;\s]+)\s*:\s*([^;]+)\s*(?=;|$)/g,
                        function (a, c, w) { b && (c = c.toLowerCase(), "font-family" == c && (w = w.replace(/\s*,\s*/g, ",")), w = CKEDITOR.tools.trim(w)); g[c] = w }); return g
                    ...
                    var c = {}; 1 == arguments.length &&
                        (b = !0); for (var g = 0, h = a.length; g < h; ++g)c[a[g]] = b; return c
                }, getStyledSpans: function (a, b) { var c = CKEDITOR.env.ie && 8 == CKEDITOR.env.version ? a.toUpperCase() : a, c = b.find("span[style*\x3d" + c + "]").toArray(); return CKEDITOR.tools.array.filter(c, function (b) { return !!b.getStyle(a) }) }, fixDomain: function () { for (var a; ;)try { a = window.parent.document.domain; break } catch (b) { a = a ? a.replace(/.+?(?:\.|$)/, "") : document.domain; if (!a) break; document.domain = a } return !!a }, eventsBuffer: function (a, b, c) {
            ...
            getCookie: function (a) { a = a.toLowerCase(); for (var b = document.cookie.split(";"), c, g, h = 0; h < b.length; h++)if (c = b[h].split("\x3d"), g = decodeURIComponent(CKEDITOR.tools.trim(c[0]).toLowerCase()), g === a) return decodeURIComponent(1 < c.length ? c[1] : ""); return null }, setCookie: function (a, b) { document.cookie = encodeURIComponent(a) + "\x3d" + encodeURIComponent(b) + ";path\x3d/" }, getCsrfToken: function () {
                ...
                if (a) if (window.CSS && CSS.escape) a = CSS.escape(a); else {
                    a = String(a); for (var b = a.length, c = -1, g, h = "", m = a.charCodeAt(0); ++c < b;)g = a.charCodeAt(c), h = 0 == g ? h + "�" : 127 == g || 1 <= g && 31 >= g || 0 == c && 48 <=
                        g && 57 >= g || 1 == c && 48 <= g && 57 >= g && 45 == m ? h + ("\\" + g.toString(16) + " ") : 0 == c && 1 == b && 45 == g ? h + ("\\" + a.charAt(c)) : 128 <= g || 45 == g || 95 == g || 48 <= g && 57 >= g || 65 <= g && 90 >= g || 97 <= g && 122 >= g ? h + a.charAt(c) : h + ("\\" + a.charAt(c)); a = h
                } else a = ""; return a
                ...
                var b = "", c = a.length, g; for (g = 0; g < c; g += 3) {
                    var h = a.slice(g, g + 3), m = h.length, e = [], d; if (3 > m) for (d = m; 3 > d; d++)h[d] = 0; e[0] = (h[0] & 252) >> 2; e[1] = (h[0] & 3) << 4 | h[1] >> 4; e[2] = (h[1] & 15) << 2 | (h[2] & 192) >> 6; e[3] = h[2] & 63; for (d = 0; 4 > d; d++)b = d <= m ?
                ...
                filter: function (a, b, c) {
                    var g = []; this.forEach(a,
                        function (h, m) { b.call(c, h, m, a) && g.push(h) }); return g
        ...
        function a(a, b) { return -1 < (" " + a + " ").replace(e, " ").indexOf(" " + b + " ") } function d(a) { var b = !0; a.$.id || (a.$.id = "cke_tmp_" + CKEDITOR.tools.getNextNumber(), b = !1); return function () { b || a.removeAttribute("id") } } function b(a, b) { var c = CKEDITOR.tools.escapeCss(a.$.id); return "#" + c + " " + b.split(/,\s*/).join(", #" + c + " ") } function c(a) { for (var b = 0, c = 0, g = k[a].length; c < g; c++)b += parseFloat(this.getComputedStyle(k[a][c]) || 0, 10) || 0; return b } var f = document.createElement("_").classList, f = "undefined" !== typeof f &&
            null !== String(f.add).match(/\[Native code\]/gi), e = /[\n\t\r]/g; CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
                ...
                is: function () { var a = this.getName(); if ("object" == typeof arguments[0]) return !!arguments[0][a]; for (var b = 0; b < arguments.length; b++)if (arguments[b] == a) return !0; return !1 }, isEditable: function (a) {
                    ...
                    CKEDITOR.env.webkit && (e = this.getEditor(!1)) && (e._.previousScrollTop = null); e = a.getWindow(); d = t(this, e); var v = t(a, e), J = this.$.offsetHeight; g = this.$.offsetWidth; var E = a.$.clientHeight, u = a.$.clientWidth; e = d.x - m(this, "left") - v.x || 0; f = d.y - m(this, "top") - v.y || 0; g = d.x + g + m(this, "right") - (v.x + u) || 0; d = d.y + J + m(this, "bottom") - (v.y + E) || 0; (0 > f || 0 < d) && k(0, !0 === b ? f : !1 === b ? d : 0 > f ? f : d); c && (0 > e || 0 < g) && k(0 > e ? e : g, 0)
    ...
    (function () {
        function a(a, b) {
            var c = this.range; if (this._.end) return null; if (!this._.start) { this._.start = 1; if (c.collapsed) return this.end(), null; c.optimize() } var g, d = c.startContainer; g = c.endContainer; var e = c.startOffset, f = c.endOffset, w, h = this.guard, k = this.type, r = a ? "getPreviousSourceNode" : "getNextSourceNode"; if (!a && !this._.guardLTR) {
                var l = g.type == CKEDITOR.NODE_ELEMENT ? g : g.getParent(), x = g.type == CKEDITOR.NODE_ELEMENT ? g.getChild(f) : g.getNext(); this._.guardLTR = function (a, b) {
                    return (!b || !l.equals(a)) && (!x ||
                        !a.equals(x)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
                }
        ...
        CKEDITOR.dom.walker.bookmark = function (a, b) { function c(a) { return a && a.getName && "span" == a.getName() && a.data("cke-bookmark") } return function (g) { var d, e; d = g && g.type != CKEDITOR.NODE_ELEMENT && (e = g.getParent()) && c(e); d = a ? d : d || c(g); return !!(b ^ d) } }; CKEDITOR.dom.walker.whitespaces = function (a) { return function (b) { var c; b && b.type == CKEDITOR.NODE_TEXT && (c = !CKEDITOR.tools.trim(b.getText()) || CKEDITOR.env.webkit && b.getText() == CKEDITOR.dom.selection.FILLING_CHAR_SEQUENCE); return !!(a ^ c) } }; CKEDITOR.dom.walker.invisible =
            function (a) { var b = CKEDITOR.dom.walker.whitespaces(), c = CKEDITOR.env.webkit ? 1 : 0; return function (g) { b(g) ? g = 1 : (g.type == CKEDITOR.NODE_TEXT && (g = g.getParent()), g = g.$.offsetWidth <= c); return !!(a ^ g) } }; CKEDITOR.dom.walker.nodeType = function (a, b) { return function (c) { return !!(b ^ c.type == a) } }; CKEDITOR.dom.walker.bogus = function (a) {
                ...
                function (a) { return function (b) { b = e(b) || k(b) || h(b); return !!(a ^ b) } }; var r = CKEDITOR.dom.walker.ignored(); CKEDITOR.dom.walker.empty = function (a) { return function (b) { for (var c = 0, g = b.getChildCount(); c < g; ++c)if (!r(b.getChild(c))) return !!a; return !a } }; var g = CKEDITOR.dom.walker.empty(), w = CKEDITOR.dom.walker.validEmptyBlockContainers = CKEDITOR.tools.extend(function (a) { var b = {}, c; for (c in a) CKEDITOR.dtd[c]["#"] && (b[c] = 1); return b }(CKEDITOR.dtd.$block), { caption: 1, td: 1, th: 1 }); CKEDITOR.dom.walker.editable = function (a) {
                    return function (b) {
                        b =
                        r(b) ? !1 : b.type == CKEDITOR.NODE_TEXT || b.type == CKEDITOR.NODE_ELEMENT && (b.is(CKEDITOR.dtd.$inline) || b.is("hr") || "false" == b.getAttribute("contenteditable") || !CKEDITOR.env.needsBrFiller && b.is(w) && g(b)) ? !0 : !1; return !!(a ^ b)
                    }
    ...
    (function () {
        function a(a) { a.collapsed = a.startContainer && a.endContainer && a.startContainer.equals(a.endContainer) && a.startOffset == a.endOffset } function d(a, b, c, d, e) {
            function f(a, b, c, g) { var L = c ? a.getPrevious() : a.getNext(); if (g && k) return L; l || g ? b.append(a.clone(!0, e), c) : (a.remove(), r && b.append(a, c)); return L } function m() { var a, b, c, g = Math.min(O.length, q.length); for (a = 0; a < g; a++)if (b = O[a], c = q[a], !b.equals(c)) return a; return a - 1 } function h() {
                var b = I - 1, c = D && B && !u.equals(F); b < N - 1 || b < n - 1 || c ? (c ? a.moveToPosition(F,
                    CKEDITOR.POSITION_BEFORE_START) : n == b + 1 && p ? a.moveToPosition(q[b], CKEDITOR.POSITION_BEFORE_END) : a.moveToPosition(q[b + 1], CKEDITOR.POSITION_BEFORE_START), d && (b = O[b + 1]) && b.type == CKEDITOR.NODE_ELEMENT && (c = CKEDITOR.dom.element.createFromHtml('\x3cspan data-cke-bookmark\x3d"1" style\x3d"display:none"\x3e\x26nbsp;\x3c/span\x3e', a.document), c.insertAfter(b), b.mergeSiblings(!1), a.moveToBookmark({ startNode: c }))) : a.collapse(!0)
            } a.optimizeBookmark(); var k = 0 === b, r = 1 == b, l = 2 == b; b = l || r; var u = a.startContainer, F = a.endContainer,
                H = a.startOffset, x = a.endOffset, K, p, D, B, G, T; if (l && F.type == CKEDITOR.NODE_TEXT && (u.equals(F) || u.type === CKEDITOR.NODE_ELEMENT && u.getFirst().equals(F))) c.append(a.document.createText(F.substring(H, x))); else {
                    F.type == CKEDITOR.NODE_TEXT ? l ? T = !0 : F = F.split(x) : 0 < F.getChildCount() ? x >= F.getChildCount() ? (F = F.getChild(x - 1), p = !0) : F = F.getChild(x) : B = p = !0; u.type == CKEDITOR.NODE_TEXT ? l ? G = !0 : u.split(H) : 0 < u.getChildCount() ? 0 === H ? (u = u.getChild(H), K = !0) : u = u.getChild(H - 1) : D = K = !0; for (var O = u.getParents(), q = F.getParents(), I = m(),
                        N = O.length - 1, n = q.length - 1, C = c, L, aa, X, ea = -1, W = I; W <= N; W++) { aa = O[W]; X = aa.getNext(); for (W != N || aa.equals(q[W]) && N < n ? b && (L = C.append(aa.clone(0, e))) : K ? f(aa, C, !1, D) : G && C.append(a.document.createText(aa.substring(H))); X;) { if (X.equals(q[W])) { ea = W; break } X = f(X, C) } C = L } C = c; for (W = I; W <= n; W++)if (c = q[W], X = c.getPrevious(), c.equals(O[W])) b && (C = C.getChild(0)); else { W != n || c.equals(O[W]) && n < N ? b && (L = C.append(c.clone(0, e))) : p ? f(c, C, !1, B) : T && C.append(a.document.createText(c.substring(0, x))); if (W > ea) for (; X;)X = f(X, C, !0); C = L } l ||
                            h()
                }
        ...
        function f(a) { return function () { var b; return this[a ? "getPreviousNode" : "getNextNode"](function (a) { !b && r(a) && (b = a); return l(a) && !(k(a) && a.equals(b)) }) } } var e = { abbr: 1, acronym: 1, b: 1, bdo: 1, big: 1, cite: 1, code: 1, del: 1, dfn: 1, em: 1, font: 1, i: 1, ins: 1, label: 1, kbd: 1, q: 1, samp: 1, small: 1, span: 1, strike: 1, strong: 1, sub: 1, sup: 1, tt: 1, u: 1, "var": 1 }, k = CKEDITOR.dom.walker.bogus(), h = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, l = CKEDITOR.dom.walker.editable(), r = CKEDITOR.dom.walker.ignored(!0); CKEDITOR.dom.range.prototype = {
            clone: function () {
                ...
                } var c = this.startContainer, d = this.endContainer, e = this.collapsed, f, m, h, k; f = this.document.createElement("span"); f.data("cke-bookmark", 1); f.setStyle("display", "none"); f.setHtml("\x26nbsp;"); a && (h = "cke_bm_" + CKEDITOR.tools.getNextNumber(), f.setAttribute("id", h + (e ? "C" : "S"))); e || (m = f.clone(), m.setHtml("\x26nbsp;"), a && m.setAttribute("id", h + "E"), k = this.clone(), b(d) && (d = b(d),
                ...
                function a(b) {
                    ...
                    var d = this.collapsed, e = { container: this.startContainer, offset: this.startOffset }, m = { container: this.endContainer, offset: this.endOffset }; c && (a(e), b(e, this.root),
                        d || (a(m), b(m, this.root))); return { start: e.container.getAddress(c), end: d ? null : m.container.getAddress(c), startOffset: e.offset, endOffset: m.offset, normalized: c, collapsed: d, is2: !0 }
                }
                ...
                function c(a) { return a && a.type == CKEDITOR.NODE_ELEMENT && a.hasAttribute("contenteditable") ? null : a } var d = new RegExp(/[^\s\ufeff]/); switch (a) {
                    case CKEDITOR.ENLARGE_INLINE: var e = 1; case CKEDITOR.ENLARGE_ELEMENT: var f = function (a, b) {
                        var c = new CKEDITOR.dom.range(h); c.setStart(a, b); c.setEndAt(h, CKEDITOR.POSITION_BEFORE_END); var c = new CKEDITOR.dom.walker(c), g; for (c.guard =
                            function (a) { return !(a.type == CKEDITOR.NODE_ELEMENT && a.isBlockBoundary()) }; g = c.next();) { if (g.type != CKEDITOR.NODE_TEXT) return !1; K = g != a ? g.getText() : g.substring(b); if (d.test(K)) return !1 } return !0
                    }; if (this.collapsed) break; var m = this.getCommonAncestor(), h = this.root, k, r, l, u, F, H = !1, x, K; x = this.startContainer; var p = this.startOffset; x.type == CKEDITOR.NODE_TEXT ? (p && (x = !CKEDITOR.tools.trim(x.substring(0, p)).length && x, H = !!x), x && ((u = x.getPrevious()) || (l = x.getParent()))) : (p && (u = x.getChild(p - 1) || x.getLast()), u || (l = x));
                        for (l = c(l); l || u;) {
                            if (l && !u) { !F && l.equals(m) && (F = !0); if (e ? l.isBlockBoundary() : !h.contains(l)) break; H && "inline" == l.getComputedStyle("display") || (H = !1, F ? k = l : this.setStartBefore(l)); u = l.getPrevious() } for (; u;)if (x = !1, u.type == CKEDITOR.NODE_COMMENT) u = u.getPrevious(); else {
                                if (u.type == CKEDITOR.NODE_TEXT) K = u.getText(), d.test(K) && (u = null), x = /[\s\ufeff]$/.test(K); else if ((u.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && u.is("br")) && !u.data("cke-bookmark")) if (H && CKEDITOR.dtd.$removeEmpty[u.getName()]) {
                                    K = u.getText();
                                    if (d.test(K)) u = null; else for (var p = u.$.getElementsByTagName("*"), D = 0, B; B = p[D++];)if (!CKEDITOR.dtd.$removeEmpty[B.nodeName.toLowerCase()]) { u = null; break } u && (x = !!K.length)
                                } else u = null; x && (H ? F ? k = l : l && this.setStartBefore(l) : H = !0); if (u) { x = u.getPrevious(); if (!l && !x) { l = u; u = null; break } u = x } else l = null
                            } l && (l = c(l.getParent()))
                        } x = this.endContainer; p = this.endOffset; l = u = null; F = H = !1; x.type == CKEDITOR.NODE_TEXT ? CKEDITOR.tools.trim(x.substring(p)).length ? H = !0 : (H = !x.getLength(), p == x.getLength() ? (u = x.getNext()) || (l = x.getParent()) :
                            f(x, p) && (l = x.getParent())) : (u = x.getChild(p)) || (l = x); for (; l || u;) {
                                if (l && !u) { !F && l.equals(m) && (F = !0); if (e ? l.isBlockBoundary() : !h.contains(l)) break; H && "inline" == l.getComputedStyle("display") || (H = !1, F ? r = l : l && this.setEndAfter(l)); u = l.getNext() } for (; u;) {
                                    x = !1; if (u.type == CKEDITOR.NODE_TEXT) K = u.getText(), f(u, 0) || (u = null), x = /^[\s\ufeff]/.test(K); else if (u.type == CKEDITOR.NODE_ELEMENT) {
                                        if ((0 < u.$.offsetWidth || b && u.is("br")) && !u.data("cke-bookmark")) if (H && CKEDITOR.dtd.$removeEmpty[u.getName()]) {
                                            K = u.getText(); if (d.test(K)) u =
                                                null; else for (p = u.$.getElementsByTagName("*"), D = 0; B = p[D++];)if (!CKEDITOR.dtd.$removeEmpty[B.nodeName.toLowerCase()]) { u = null; break } u && (x = !!K.length)
                                        } else u = null
                                    } else x = 1; x && H && (F ? r = l : this.setEndAfter(l)); if (u) { x = u.getNext(); if (!l && !x) { l = u; u = null; break } u = x } else l = null
                                } l && (l = c(l.getParent()))
                            } k && r && (m = k.contains(r) ? r : k, this.setStartBefore(m), this.setEndAfter(m)); break; case CKEDITOR.ENLARGE_BLOCK_CONTENTS: case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS: l = new CKEDITOR.dom.range(this.root); h = this.root; l.setStartAt(h,
                                CKEDITOR.POSITION_AFTER_START); l.setEnd(this.startContainer, this.startOffset); l = new CKEDITOR.dom.walker(l); var G, T, O = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? { br: 1 } : null), q = null, I = function (a) { if (a.type == CKEDITOR.NODE_ELEMENT && "false" == a.getAttribute("contenteditable")) if (q) { if (q.equals(a)) { q = null; return } } else q = a; else if (q) return; var b = O(a); b || (G = a); return b }, e = function (a) { var b = I(a); !b && a.is && a.is("br") && (T = a); return b }; l.guard = I; l = l.lastBackward(); G = G || h; this.setStartAt(G,
                                    !G.is("br") && (!l && this.checkStartOfBlock() || l && G.contains(l)) ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_AFTER_END); if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) { l = this.clone(); l = new CKEDITOR.dom.walker(l); var N = CKEDITOR.dom.walker.whitespaces(), n = CKEDITOR.dom.walker.bookmark(); l.evaluator = function (a) { return !N(a) && !n(a) }; if ((l = l.previous()) && l.type == CKEDITOR.NODE_ELEMENT && l.is("br")) break } l = this.clone(); l.collapse(); l.setEndAt(h, CKEDITOR.POSITION_BEFORE_END); l = new CKEDITOR.dom.walker(l); l.guard =
                                        a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? e : I; G = q = T = null; l = l.lastForward(); G = G || h; this.setEndAt(G, !l && this.checkEndOfBlock() || l && G.contains(l) ? CKEDITOR.POSITION_BEFORE_END : CKEDITOR.POSITION_BEFORE_START); T && this.setEndAfter(T)
                }
                ...
                var d = "boolean" === typeof c ? c : c && "boolean" === typeof c.shrinkOnBlockBoundary ? c.shrinkOnBlockBoundary : !0, e = c && c.skipBogus; if (!this.collapsed) {
                    a = a || CKEDITOR.SHRINK_TEXT; var f = this.clone(), m = this.startContainer, h = this.endContainer, k = this.startOffset, l = this.endOffset,
                        r = c = 1; m && m.type == CKEDITOR.NODE_TEXT && (k ? k >= m.getLength() ? f.setStartAfter(m) : (f.setStartBefore(m), c = 0) : f.setStartBefore(m)); h && h.type == CKEDITOR.NODE_TEXT && (l ? l >= h.getLength() ? f.setEndAfter(h) : (f.setEndAfter(h), r = 0) : f.setEndBefore(h)); var f = new CKEDITOR.dom.walker(f), u = CKEDITOR.dom.walker.bookmark(), F = CKEDITOR.dom.walker.bogus(); f.evaluator = function (b) { return b.type == (a == CKEDITOR.SHRINK_ELEMENT ? CKEDITOR.NODE_ELEMENT : CKEDITOR.NODE_TEXT) }; var H; f.guard = function (b, c) {
                            if (e && F(b) || u(b)) return !0; if (a == CKEDITOR.SHRINK_ELEMENT &&
                                b.type == CKEDITOR.NODE_TEXT || c && b.equals(H) || !1 === d && b.type == CKEDITOR.NODE_ELEMENT && b.isBlockBoundary() || b.type == CKEDITOR.NODE_ELEMENT && b.hasAttribute("contenteditable")) return !1; c || b.type != CKEDITOR.NODE_ELEMENT || (H = b); return !0
                        }; c && (m = f[a == CKEDITOR.SHRINK_ELEMENT ? "lastForward" : "next"]()) && this.setStartAt(m, b ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_BEFORE_START); r && (f.reset(), (f = f[a == CKEDITOR.SHRINK_ELEMENT ? "lastBackward" : "previous"]()) && this.setEndAt(f, b ? CKEDITOR.POSITION_BEFORE_END : CKEDITOR.POSITION_AFTER_END));
                    return !(!c && !r)
                }
                ...
                b) { var c = this.createBookmark(), d = this.document.createElement(b); this.collapse(a); this.enlarge(CKEDITOR.ENLARGE_BLOCK_CONTENTS); this.extractContents().appendTo(d); d.trim(); this.insertNode(d); var e = d.getBogus(); e && e.remove(); d.appendBogus(); this.moveToBookmark(c); return d }, splitBlock: function (a, b) {
                    var c = new CKEDITOR.dom.elementPath(this.startContainer, this.root), d = new CKEDITOR.dom.elementPath(this.endContainer, this.root), e = c.block, f = d.block, m = null; if (!c.blockLimit.equals(d.blockLimit)) return null; "br" !=
                        a && (e || (e = this.fixBlock(!0, a), f = (new CKEDITOR.dom.elementPath(this.endContainer, this.root)).block), f || (f = this.fixBlock(!1, a))); c = e && this.checkStartOfBlock(); d = f && this.checkEndOfBlock(); this.deleteContents(); e && e.equals(f) && (d ? (m = new CKEDITOR.dom.elementPath(this.startContainer, this.root), this.moveToPosition(f, CKEDITOR.POSITION_AFTER_END), f = null) : c ? (m = new CKEDITOR.dom.elementPath(this.startContainer, this.root), this.moveToPosition(e, CKEDITOR.POSITION_BEFORE_START), e = null) : (f = this.splitElement(e, b ||
                            !1), e.is("ul", "ol") || e.appendBogus())); return { previousBlock: e, nextBlock: f, wasStartOfBlock: c, wasEndOfBlock: d, elementPath: m }
                    ...
                    if (a.type == CKEDITOR.NODE_ELEMENT && !a.isEditable(!1)) return this.moveToPosition(a, b ? CKEDITOR.POSITION_AFTER_END : CKEDITOR.POSITION_BEFORE_START),
                        !0; for (var c = 0; a;) {
                            ...
                            else if ("false" == a.getAttribute("contenteditable") && a.is(CKEDITOR.dtd.$block)) return this.setStartBefore(a), this.setEndAfter(a), !0; var d = a, e = c, f = void 0; d.type == CKEDITOR.NODE_ELEMENT && d.isEditable(!1) && (f = d[b ? "getLast" : "getFirst"](r)); e || f || (f = d[b ? "getPrevious" : "getNext"](r)); a = f
                        } return !!c
                }, moveToClosestEditablePosition: function (a, b) {
                    var c, d = 0, e, f, m = [CKEDITOR.POSITION_AFTER_END, CKEDITOR.POSITION_BEFORE_START]; a ? (c = new CKEDITOR.dom.range(this.root), c.moveToPosition(a, m[b ? 0 : 1])) : c = this.clone(); if (a &&
            ...
            moveToElementEditEnd: function (a) { return this.moveToElementEditablePosition(a, !0) }, getEnclosedNode: function () { var a = this.clone(); a.optimize(); if (a.startContainer.type != CKEDITOR.NODE_ELEMENT || a.endContainer.type != CKEDITOR.NODE_ELEMENT) return null; var a = new CKEDITOR.dom.walker(a), b = CKEDITOR.dom.walker.bookmark(!1, !0), c = CKEDITOR.dom.walker.whitespaces(!0); a.evaluator = function (a) { return c(a) && b(a) }; var d = a.next(); a.reset(); return d && d.equals(a.previous()) ? d : null }, getTouchedStartNode: function () {
                ...
                var c = this.getCommonAncestor(), d = this.getBoundaryNodes(), e = [], f, m, h, k; if (c && c.find) for (m = c.find(a), f = 0; f < m.count(); f++)if (c = m.getItem(f), b || !c.isReadOnly()) h = c.getPosition(d.startNode) & CKEDITOR.POSITION_FOLLOWING || d.startNode.equals(c), k = c.getPosition(d.endNode) & CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IS_CONTAINED ||
        ...
        function a(a) { 1 > arguments.length || (this.range = a, this.forceBrBreak = 0, this.enlargeBr = 1, this.enforceRealBlocks = 0, this._ || (this._ = {})) } function d(a) { var b = []; a.forEach(function (a) { if ("true" == a.getAttribute("contenteditable")) return b.push(a), !1 }, CKEDITOR.NODE_ELEMENT, !0); return b } function b(a, c, e, f) {
            ...
            h = function (a) { return e(a) && k(a) }, l = { dd: 1, dt: 1, li: 1 }; a.prototype = {
                getNextParagraph: function (a) {
                    var d, k, y, z, A; a = a || "p"; if (this._.nestedEditable) {
                        ...
                        var t = this.range.clone(); k = t.startPath(); var m = t.endPath(), M = !t.collapsed && c(t, k.block), v = !t.collapsed && c(t, m.block, 1); t.shrink(CKEDITOR.SHRINK_ELEMENT, !0); M && t.setStartAt(k.block, CKEDITOR.POSITION_BEFORE_END); v && t.setEndAt(m.block, CKEDITOR.POSITION_AFTER_START); k = t.endContainer.hasAscendant("pre", !0) || t.startContainer.hasAscendant("pre", !0); t.enlarge(this.forceBrBreak && !k || !this.enlargeBr ? CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS : CKEDITOR.ENLARGE_BLOCK_CONTENTS);
                        t.collapsed || (k = new CKEDITOR.dom.walker(t.clone()), m = CKEDITOR.dom.walker.bookmark(!0, !0), k.evaluator = m, this._.nextNode = k.next(), k = new CKEDITOR.dom.walker(t.clone()), k.evaluator = m, k = k.previous(), this._.lastNode = k.getNextSourceNode(!0, null, t.root), this._.lastNode && this._.lastNode.type == CKEDITOR.NODE_TEXT && !CKEDITOR.tools.trim(this._.lastNode.getText()) && this._.lastNode.getParent().isBlockBoundary() && (m = this.range.clone(), m.moveToPosition(this._.lastNode, CKEDITOR.POSITION_AFTER_END), m.checkEndOfBlock() &&
                            (m = new CKEDITOR.dom.elementPath(m.endContainer, m.root), this._.lastNode = (m.block || m.blockLimit).getNextSourceNode(!0))), this._.lastNode && t.root.contains(this._.lastNode) || (this._.lastNode = this._.docEndMarker = t.document.createText(""), this._.lastNode.insertAfter(k)), t = null); this._.started = 1; k = t
                    } m = this._.nextNode; t = this._.lastNode; for (this._.nextNode = null; m;) {
                        var M = 0, v = m.hasAscendant("pre"), J = m.type != CKEDITOR.NODE_ELEMENT, E = 0; if (J) m.type == CKEDITOR.NODE_TEXT && f.test(m.getText()) && (J = 0); else {
                            var u = m.getName();
                        ...
                        y = (!M || J) && m.equals(t); if (k && !M) for (; !m.getNext(h) && !y;) { u = m.getParent(); if (u.isBlockBoundary(this.forceBrBreak && !v && { br: 1 })) { M = 1; J = 0; y || u.equals(t); k.setEndAt(u, CKEDITOR.POSITION_BEFORE_END); break } m = u; J = 1; y = m.equals(t); E = 1 } J && k.setEndAt(m, CKEDITOR.POSITION_AFTER_END); m = this._getNextSourceNode(m, E, t); if ((y = !m) || M && k) break
                    } if (!d) {
    ...
    (function () {
        function a(a, b, c, d, e) {
            var f, g; a = []; for (f in b) {
                g = b[f]; g = "boolean" == typeof g ? {} : "function" == typeof g ? { match: g } : D(g); "$" != f.charAt(0) && (g.elements = f); c && (g.featureName = c.toLowerCase()); var n = g; n.elements = k(n.elements, /\s+/) || null; n.propertiesOnly = n.propertiesOnly || !0 === n.elements; var p = /\s*,\s*/, q = void 0; for (q in T) {
                    n[q] = k(n[q], p) || null; var B = n, m = O[q], x = k(n[O[q]], p), h = n[q], C = [], G = !0, I = void 0; x ? G = !1 : x = {}; for (I in h) "!" == I.charAt(0) && (I = I.slice(1), C.push(I), x[I] = !0, G = !1); for (; I = C.pop();)h[I] =
                        h["!" + I], delete h["!" + I]; B[m] = (G ? !1 : x) || null
                } n.match = n.match || null; d.push(g); a.push(g)
            } b = e.elements; e = e.generic; var l; c = 0; for (d = a.length; c < d; ++c) {
                f = D(a[c]); g = !0 === f.classes || !0 === f.styles || !0 === f.attributes; n = f; q = m = p = void 0; for (p in T) n[p] = M(n[p]); B = !0; for (q in O) { p = O[q]; m = n[p]; x = []; h = void 0; for (h in m) -1 < h.indexOf("*") ? x.push(new RegExp("^" + h.replace(/\*/g, ".*") + "$")) : x.push(h); m = x; m.length && (n[p] = m, B = !1) } n.nothingRequired = B; n.noProperties = !(n.attributes || n.classes || n.styles); if (!0 === f.elements ||
                    null === f.elements) e[g ? "unshift" : "push"](f); else for (l in n = f.elements, delete f.elements, n) if (b[l]) b[l][g ? "unshift" : "push"](f); else b[l] = [f]
            }
        } function d(a, c, d, e) {
            ...
            b) { if (!a) return !1; var c = !1, d = !0 === a, e; for (e in b) if (d || a(e)) delete b[e], c = !0; return c } function e(a, b, c) { if (a.disabled || a.customConfig && !c || !b) return !1; a._.cachedChecks = {}; return !0 } function k(a, b) { if (!a) return !1; if (!0 === a) return a; if ("string" == typeof a) return a = B(a), "*" == a ? !0 : CKEDITOR.tools.convertArrayToObject(a.split(b)); if (CKEDITOR.tools.isArray(a)) return a.length ? CKEDITOR.tools.convertArrayToObject(a) : !1; var c = {}, d = 0, e; for (e in a) c[e] = a[e], d++; return d ? c : !1 } function h(a, b) {
            ...
            } function l(a, b) { if (!b) return !0; for (var c = 0, d; c < b.length; ++c)if (d = b[c], "string" == typeof d) { if (!(d in a)) return !1 } else if (!CKEDITOR.tools.checkIfAnyObjectPropertyMatches(a, d)) return !1; return !0 } function r(a) {
                if (!a) return {};
                a = a.split(/\s*,\s*/).sort(); for (var b = {}; a.length;)b[a.shift()] = "cke-test"; return b
            } function g(a) { var b, c, d, e, f = {}, g = 1; for (a = B(a); b = a.match(q);)(c = b[2]) ? (d = w(c, "styles"), e = w(c, "attrs"), c = w(c, "classes")) : d = e = c = null, f["$" + g++] = { elements: b[1], classes: c, styles: d, attributes: e }, a = a.slice(b[0].length); return f } function w(a, b) { var c = a.match(I[b]); return c ? B(c[1]) : null } function y(a) {
                ...
                var g = 0, p; f.toHtml && (b.name = b.name.replace(N, "$1")); if (f.doCallbacks && a.elementCallbacks) { a: { p = a.elementCallbacks; for (var q = 0, B = p.length, D; q < B; ++q)if (D = p[q](b)) { p = D; break a } p = void 0 } if (p) return p } if (f.doTransform && (p = a._.transformations[b.name])) { y(b); for (q = 0; q < p.length; ++q)u(a, b, p[q]); t(b) } if (f.doFilter) {
                    a: {
                        q = b.name; B = a._; a = B.allowedRules.elements[q]; p = B.allowedRules.generic; q = B.disallowedRules.elements[q]; B = B.disallowedRules.generic;
                        D = f.skipRequired; var k = { valid: !1, validAttributes: {}, validClasses: {}, validStyles: {}, allAttributes: !1, allClasses: !1, allStyles: !1, hadInvalidAttribute: !1, hadInvalidClass: !1, hadInvalidStyle: !1 }, x, h; if (a || p) { y(b); if (q) for (x = 0, h = q.length; x < h; ++x)if (!1 === c(q[x], b, k)) { a = null; break a } if (B) for (x = 0, h = B.length; x < h; ++x)c(B[x], b, k); if (a) for (x = 0, h = a.length; x < h; ++x)d(a[x], b, k, D); if (p) for (x = 0, h = p.length; x < h; ++x)d(p[x], b, k, D); a = k } else a = null
                    } if (!a || !a.valid) return e.push(b), 1; h = a.validAttributes; var C = a.validStyles;
                    p = a.validClasses; var q = b.attributes, G = b.styles, B = b.classes; D = b.classBackup; var O = b.styleBackup, I, l, K = [], k = [], T = /^data-cke-/; x = !1; delete q.style; delete q["class"]; delete b.classBackup; delete b.styleBackup; if (!a.allAttributes) for (I in q) h[I] || (T.test(I) ? I == (l = I.replace(/^data-cke-saved-/, "")) || h[l] || (delete q[I], x = !0) : (delete q[I], x = !0)); if (!a.allStyles || a.hadInvalidStyle) { for (I in G) a.allStyles || C[I] ? K.push(I + ":" + G[I]) : x = !0; K.length && (q.style = K.sort().join("; ")) } else O && (q.style = O); if (!a.allClasses ||
                        a.hadInvalidClass) { for (I = 0; I < B.length; ++I)(a.allClasses || p[B[I]]) && k.push(B[I]); k.length && (q["class"] = k.sort().join(" ")); D && k.length < D.split(/\s+/).length && (x = !0) } else D && (q["class"] = D); x && (g = 1); if (!f.skipFinalValidation && !m(b)) return e.push(b), 1
                } f.toHtml && (b.name = b.name.replace(n, "cke:$1")); return g
            } function A(a) { var b = [], c; for (c in a) -1 < c.indexOf("*") && b.push(c.replace(/\*/g, ".*")); return b.length ? new RegExp("^(?:" + b.join("|") + ")$") : null } function t(a) {
            ...
            } function m(a) { switch (a.name) { case "a": if (!(a.children.length || a.attributes.name || a.attributes.id)) return !1; break; case "img": if (!a.attributes.src) return !1 }return !0 } function M(a) { if (!a) return !1; if (!0 === a) return !0; var b = A(a); return function (c) { return c in a || b && c.match(b) } } function v() { return new CKEDITOR.htmlParser.element("br") } function J(a) {
                return a.type == CKEDITOR.NODE_ELEMENT && ("br" ==
                    a.name || p.$block[a.name])
            } function E(a, b, c) {
                var d = a.name; if (p.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(v()) : (a.parent && c.push({ check: "it", el: a.parent }), a.remove()); else if (p.$block[d] || "tr" == d) if ("br" == b) a.previous && !J(a.previous) && (b = v(), b.insertBefore(a)), a.next && !J(a.next) && (b = v(), b.insertAfter(a)), a.replaceWithChildren(); else {
                    var d = a.children, e; b: { e = p[b]; for (var f = 0, g = d.length, n; f < g; ++f)if (n = d[f], n.type == CKEDITOR.NODE_ELEMENT && !e[n.name]) { e = !1; break b } e = !0 } if (e) a.name = b, a.attributes =
                        {}, c.push({ check: "parent-down", el: a }); else { e = a.parent; for (var f = e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == e.name, q, B, g = d.length; 0 < g;)n = d[--g], f && (n.type == CKEDITOR.NODE_TEXT || n.type == CKEDITOR.NODE_ELEMENT && p.$inline[n.name]) ? (q || (q = new CKEDITOR.htmlParser.element(b), q.insertAfter(a), c.push({ check: "parent-down", el: q })), q.add(n, 0)) : (q = null, B = p[e.name] || p.span, n.insertAfter(a), e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || n.type != CKEDITOR.NODE_ELEMENT || B[n.name] || c.push({ check: "el-up", el: n })); a.remove() }
                } else d in
                    { style: 1, script: 1 } ? a.remove() : (a.parent && c.push({ check: "it", el: a.parent }), a.replaceWithChildren())
            } function u(a, b, c) { var d, e; for (d = 0; d < c.length; ++d)if (e = c[d], !(e.check && !a.check(e.check, !1) || e.left && !e.left(b))) { e.right(b, C); break } } function F(a, b) {
                var c = b.getDefinition(), d = c.attributes, e = c.styles, f, g, n, p; if (a.name != c.element) return !1; for (f in d) if ("class" == f) for (c = d[f].split(/\s+/), n = a.classes.join("|"); p = c.pop();) { if (-1 == n.indexOf(p)) return !1 } else if (a.attributes[f] != d[f]) return !1; for (g in e) if (a.styles[g] !=
                ...
                this.allowedContent = []; this.disallowedContent = []; this.elementCallbacks = null; this.disabled =
                    !1; this.editor = null; this.id = CKEDITOR.tools.getNextNumber(); this._ = { allowedRules: { elements: {}, generic: [] }, disallowedRules: { elements: {}, generic: [] }, transformations: {}, cachedTests: {}, cachedChecks: {} }; CKEDITOR.filter.instances[this.id] = this; var c = this.editor = a instanceof CKEDITOR.editor ? a : null; if (c && !b) {
                        this.customConfig = !0; var d = c.config.allowedContent; !0 === d ? this.disabled = !0 : (d || (this.customConfig = !1), this.allow(d, "config", 1), this.allow(c.config.extraAllowedContent, "extra", 1), this.allow(G[c.enterMode] +
                            " " + G[c.shiftEnterMode], "default", 1), this.disallow(c.config.disallowedContent))
                ...
                allow: function (b, c, d) {
                    ...
                    if (this.disabled) return !1; var e = this, f = [], g = this.editor && this.editor.config.protectedSource, n, q = !1, B = { doFilter: !c, doTransform: !0, doCallbacks: !0, toHtml: b };
                    a.forEach(function (a) {
                        if (a.type == CKEDITOR.NODE_ELEMENT) { if ("off" == a.attributes["data-cke-filter"]) return !1; if (!b || "span" != a.name || !~CKEDITOR.tools.object.keys(a.attributes).join("|").indexOf("data-cke-")) if (n = z(e, a, f, B), n & 1) q = !0; else if (n & 2) return !1 } else if (a.type == CKEDITOR.NODE_COMMENT && a.value.match(/^\{cke_protected\}(?!\{C\})/)) {
                            var c; a: {
                                var d = decodeURIComponent(a.value.replace(/^\{cke_protected\}/, "")); c = []; var p, D, m; if (g) for (D = 0; D < g.length; ++D)if ((m = d.match(g[D])) && m[0].length == d.length) {
                                    c =
                                    !0; break a
                                } d = CKEDITOR.htmlParser.fragment.fromHtml(d); 1 == d.children.length && (p = d.children[0]).type == CKEDITOR.NODE_ELEMENT && z(e, p, c, B); c = !c.length
                            } c || f.push(a)
                        }
                    }, null, !0); f.length && (q = !0); var D; a = []; d = G[d || (this.editor ? this.editor.enterMode : CKEDITOR.ENTER_P)]; for (var x; c = f.pop();)c.type == CKEDITOR.NODE_ELEMENT ? E(c, d, a) : c.remove(); for (; D = a.pop();)if (c = D.el, c.parent) switch (x = p[c.parent.name] || p.span, D.check) {
                        case "it": p.$removeEmpty[c.name] && !c.children.length ? E(c, d, a) : m(c) || E(c, d, a); break; case "el-up": c.parent.type ==
                            CKEDITOR.NODE_DOCUMENT_FRAGMENT || x[c.name] || E(c, d, a); break; case "parent-down": c.parent.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || x[c.name] || E(c.parent, d, a)
                    }return q
                ...
                addContentForms: function (a) { if (!this.disabled && a) { var b, c, d = [], e; for (b = 0; b < a.length && !e; ++b)c = a[b], ("string" == typeof c || c instanceof CKEDITOR.style) && this.check(c) && (e = c); if (e) { for (b = 0; b < a.length; ++b)d.push(H(a[b], e)); this.addTransformations(d) } } }, addElementCallback: function (a) { this.elementCallbacks || (this.elementCallbacks = []); this.elementCallbacks.push(a) }, addFeature: function (a) {
                    ...
                    var b, c; if (!this.disabled && a) {
                        var d = this._.transformations, e; for (e = 0; e < a.length; ++e) {
                            b = a[e]; var f = void 0, g = void 0, n = void 0, p = void 0, q = void 0, B = void 0; c = []; for (g = 0; g < b.length; ++g)n = b[g], "string" == typeof n ? (n = n.split(/\s*:\s*/), p = n[0], q = null, B = n[1]) : (p = n.check, q = n.left, B = n.right), f || (f = n, f = f.element ? f.element : p ? p.match(/^([a-z0-9]+)/i)[0] :
                                f.left.getDefinition().element), q instanceof CKEDITOR.style && (q = x(q)), c.push({ check: p == f ? null : p, left: q, right: "string" == typeof B ? K(B) : B }); b = f; d[b] || (d[b] = []); d[b].push(c)
                        }
                    }
                    ...
                    if (this.disabled) return !0; if (CKEDITOR.tools.isArray(a)) { for (var d = a.length; d--;)if (this.check(a[d], b, c)) return !0; return !1 } var e, f; if ("string" == typeof a) {
                        ...
                        e.classes = d = d ? d.split(/\s*,\s*/) : []; e.styles = r(n); e.attributes = r(e.attributes); e.children = []; d.length && (e.attributes["class"] = d.join(" ")); n && (e.attributes.style = CKEDITOR.tools.writeCssText(e.styles))
                    } else e = a.getDefinition(), n = e.styles, d = e.attributes || {}, n && !CKEDITOR.tools.isEmpty(n) ? (n = D(n), d.style = CKEDITOR.tools.writeCssText(n, !0)) : n = {}, e = { name: e.element, attributes: d, classes: d["class"] ? d["class"].split(/\s+/) : [], styles: n, children: [] }; var n = CKEDITOR.tools.clone(e), p = [], q; if (!1 !== b && (q = this._.transformations[e.name])) {
                        for (d =
                            0; d < q.length; ++d)u(this, e, q[d]); t(e)
                    } z(this, n, p, { doFilter: !0, doTransform: !1 !== b, skipRequired: !c, skipFinalValidation: !c }); 0 < p.length ? c = !1 : ((b = e.attributes["class"]) && (e.attributes["class"] = e.attributes["class"].split(" ").sort().join(" ")), c = CKEDITOR.tools.objectCompare(e.attributes, n.attributes, !0), b && (e.attributes["class"] = b)); "string" == typeof a && (this._.cachedChecks[f] = c); return c
                }, getAllowedEnterMode: function () {
                    var a = ["p", "div", "br"], b = { p: CKEDITOR.ENTER_P, div: CKEDITOR.ENTER_DIV, br: CKEDITOR.ENTER_BR };
                    return function (c, d) { var e = a.slice(), f; if (this.check(G[c])) return c; for (d || (e = e.reverse()); f = e.pop();)if (this.check(f)) return b[f]; return CKEDITOR.ENTER_BR }
            ...
            }; var T = { styles: 1, attributes: 1, classes: 1 }, O = { styles: "requiredStyles", attributes: "requiredAttributes", classes: "requiredClasses" }, q = /^([a-z0-9\-*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i, I = { styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/, classes: /\(([^\)]+)\)/ }, N = /^cke:(object|embed|param)$/, n = /^(object|embed|param)$/, C; C = CKEDITOR.filter.transformationsTools = {
                sizeToStyle: function (a) {
                    ...
                    if ("string" == typeof b) a.name = b; else {
                        var c = b.getDefinition(), d = c.styles, e = c.attributes, f, n, g, p; a.name = c.element; for (f in e) if ("class" ==
                            f) for (c = a.classes.join("|"), g = e[f].split(/\s+/); p = g.pop();)-1 == c.indexOf(p) && a.classes.push(p); else a.attributes[f] = e[f]; for (n in d) a.styles[n] = d[n]
                    }
                }
            }
    })();
    ...
    CKEDITOR.scriptLoader = function () {
        var a = {}, d = {}; return {
            load: function (b, c, f, e) {
                var k = "string" == typeof b; k && (b = [b]); f || (f = CKEDITOR); var h = b.length, l = h, r = [], g = [], w = function (a) { c && (k ? c.call(f, a) : c.call(f, r, g)) }; if (0 === l) w(!0); else {
                    var y = function (a, b) { (b ? r : g).push(a); 0 >= --l && (e && CKEDITOR.document.getDocumentElement().removeStyle("cursor"), w(b)) }, z = function (b, c) { a[b] = 1; var e = d[b]; delete d[b]; for (var f = 0; f < e.length; f++)e[f](b, c) }, A = function (b) {
                        if (a[b]) y(b, !0); else {
    ...
    CKEDITOR.resourceManager.prototype = {
        add: function (a, d) { if (this.registered[a]) throw Error('[CKEDITOR.resourceManager.add] The resource name "' + a + '" is already registered.'); var b = this.registered[a] = d || {}; b.name = a; b.path = this.getPath(a); CKEDITOR.fire(a + CKEDITOR.tools.capitalize(this.fileName) + "Ready", b); return this.get(a) }, get: function (a) { return this.registered[a] || null }, getPath: function (a) { var d = this.externals[a]; return CKEDITOR.getUrl(d && d.dir || this.basePath + a + "/") }, getFilePath: function (a) {
            ...
            CKEDITOR.tools.isArray(a) || (a = a ? [a] : []); for (var c = this.loaded, f = this.registered, e = [], k = {}, h = {}, l = 0; l < a.length; l++) { var r = a[l]; if (r) if (c[r] || f[r]) h[r] = this.get(r); else { var g = this.getFilePath(r); e.push(g); g in k || (k[g] = []); k[g].push(r) } } CKEDITOR.scriptLoader.load(e,
            ...
            var e = {}, k = function (b) {
                a.call(this, b, function (a) {
                    CKEDITOR.tools.extend(e, a); var b = [], g; for (g in a) {
                        var h = a[g], y = h && h.requires; if (!d[g]) { if (h.icons) for (var z = h.icons.split(","), A = z.length; A--;)CKEDITOR.skin.addIcon(z[A], h.path + "icons/" + (CKEDITOR.env.hidpi && h.hidpi ? "hidpi/" : "") + z[A] + ".png"); h.isSupportedEnvironment = h.isSupportedEnvironment || function () { return !0 }; d[g] = 1 } if (y) for (y.split && (y =
    ...
    (function () {
        ...
        } function d() { do var a = "editor" + ++A; while (CKEDITOR.instances[a]); return a } function b(a, b) { return b == CKEDITOR.ELEMENT_MODE_INLINE ? a.is(CKEDITOR.dtd.$editable) || a.is("textarea") : b == CKEDITOR.ELEMENT_MODE_REPLACE ? !a.is(CKEDITOR.dtd.$nonBodyContent) : 1 } function c() { var a = this.commands, b; for (b in a) f(this, a[b]) } function f(a, b) {
        ...
        function l(a) { CKEDITOR.skin.loadPart("editor", function () { r(a) }) } function r(a) { CKEDITOR.lang.load(a.config.language, a.config.defaultLanguage, function (b, c) { var d = a.config.title; a.langCode = b; a.lang = CKEDITOR.tools.prototypedCopy(c); a.title = "string" == typeof d || !1 === d ? d : [a.lang.editor, a.name].join(", "); a.config.contentsLangDirection || (a.config.contentsLangDirection = a.elementMode == CKEDITOR.ELEMENT_MODE_INLINE ? a.element.getDirection(1) : a.lang.dir); a.fire("langLoaded"); g(a) }) } function g(a) {
            a.getStylesSet(function (b) {
                a.once("loaded",
                    function () { a.fire("stylesSet", { styles: b }) }, null, null, 1); w(a)
            })
        } function w(a) {
            function b(a) { if (!a) return ""; CKEDITOR.tools.isArray(a) && (a = a.join(",")); return a.replace(/\s/g, "") } var c = a.config, d = b(c.plugins), e = b(c.extraPlugins), f = b(c.removePlugins); if (e) var g = new RegExp("(?:^|,)(?:" + e.replace(/,/g, "|") + ")(?\x3d,|$)", "g"), d = d.replace(g, ""), d = d + ("," + e); if (f) var h = new RegExp("(?:^|,)(?:" + f.replace(/,/g, "|") + ")(?\x3d,|$)", "g"), d = d.replace(h, ""); CKEDITOR.env.air && (d += ",adobeair"); CKEDITOR.plugins.load(d.split(","),
                function (b) {
                    var d = [], e = [], f = []; a.plugins = CKEDITOR.tools.extend({}, a.plugins, b); for (var g in b) {
                        var k = b[g], l = k.lang, O = null, q = k.requires, I; CKEDITOR.tools.isArray(q) && (q = q.join(",")); if (q && (I = q.match(h))) for (; q = I.pop();)CKEDITOR.error("editor-plugin-required", { plugin: q.replace(",", ""), requiredBy: g }); l && !a.lang[g] && (l.split && (l = l.split(",")), 0 <= CKEDITOR.tools.indexOf(l, a.langCode) ? O = a.langCode : (O = a.langCode.replace(/-.*/, ""), O = O != a.langCode && 0 <= CKEDITOR.tools.indexOf(l, O) ? O : 0 <= CKEDITOR.tools.indexOf(l,
                            "en") ? "en" : l[0]), k.langEntries && k.langEntries[O] ? (a.lang[g] = k.langEntries[O], O = null) : f.push(CKEDITOR.getUrl(k.path + "lang/" + O + ".js"))); e.push(O); d.push(k)
                    } CKEDITOR.scriptLoader.load(f, function () {
                        if (!a.isDestroyed() && !a.isDetached()) {
                            for (var b = ["beforeInit", "init", "afterInit"], f = 0; f < b.length; f++)for (var g = 0; g < d.length; g++) { var q = d[g]; 0 === f && e[g] && q.lang && q.langEntries && (a.lang[q.name] = q.langEntries[e[g]]); if (q[b[f]]) q[b[f]](a) } a.fireOnce("pluginsLoaded"); c.keystrokes && a.setKeystroke(a.config.keystrokes);
            ...
            function c(a) {
                ...
                e = b.is && b.is("tr"), f = b.is && b.is("td"); a = f && b.equals(d) && a.endOffset === b.getChildCount(); b = f && 1 === b.getChildCount() && "img" === b.getChildren().getItem(0).getName(); return e || a && !b ? !0 : !1
                ...
                var l = a[k], p = l.startContainer.getAscendant("tr", !0); c(l) ? (f || (f = p.getAscendant("table").clone(), f.append(p.getAscendant({ thead: 1, tbody: 1, tfoot: 1 }).clone()), e.append(f),
                    f = f.findOne("thead, tbody, tfoot")), g && g.equals(p) || (g = p, h = p.clone(), f.append(h)), h.append(d(l))) : e.append(l.cloneContents())
            } return f ? e : b.getHtmlFromRange(a[0])
        } a.prototype = CKEDITOR.editor.prototype; CKEDITOR.editor = a; var A = 0, t = {}; CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            plugins: { detectConflict: function (a, b) { for (var c = 0; c < b.length; c++) { var d = b[c]; if (this[d]) return CKEDITOR.warn("editor-plugin-conflict", { plugin: a, replacedWith: d }), !0 } return !1 } }, addCommand: function (a, b) {
                ...
                var c = b instanceof CKEDITOR.command ? b : new CKEDITOR.command(this, b); this.mode && f(this, c); return this.commands[a] = c
            }, _attachToForm: function () {
                function a(b) { c.updateElement(); c._.required && !d.getValue() && !1 === c.fire("required") && b.data.preventDefault() } function b(a) { return !!(a && a.call && a.apply) } var c = this, d = c.element, e = new CKEDITOR.dom.element(d.$.form); d.is("textarea") && e && (e.on("submit", a), b(e.$.submit) && (e.$.submit = CKEDITOR.tools.override(e.$.submit, function (b) {
                    return function () {
                        a(); b.apply ? b.apply(this) :
                            b()
                    }
                })), c.on("destroy", function () { e.removeListener("submit", a) }))
            }, destroy: function (a) { var b = CKEDITOR.filter.instances, c = this; this.fire("beforeDestroy"); !a && y.call(this); this.editable(null); this.filter && delete this.filter; CKEDITOR.tools.array.forEach(CKEDITOR.tools.object.keys(b), function (a) { a = b[a]; c === a.editor && a.destroy() }); delete this.activeFilter; this.status = "destroyed"; this.fire("destroy"); this.removeAllListeners(); CKEDITOR.remove(this); CKEDITOR.fire("instanceDestroyed", null, this) }, elementPath: function (a) {
                if (!a) {
                    a =
            ...
            insertHtml: function (a, b, c) { this.fire("insertHtml", { dataValue: a, mode: b, range: c }) }, insertText: function (a) { this.fire("insertText", a) }, insertElement: function (a) { this.fire("insertElement", a) }, getSelectedHtml: function (a) { var b = this.editable(), c = this.getSelection(), c = c && c.getRanges(); if (!b || !c || 0 === c.length) return null; b = z(c, b); return a ? b.getHtml() : b }, extractSelectedHtml: function (a, b) {
                var c = this.editable(), d = this.getSelection().getRanges(), e = new CKEDITOR.dom.documentFragment, f; if (!c || 0 === d.length) return null;
                for (f = 0; f < d.length; f++)e.append(c.extractHtmlFromRange(d[f], b)); b || this.getSelection().selectRanges([d[0]]); return a ? e.getHtml() : e
                ...
                a || (a = this.filter); this.activeFilter !==
                    a && (this.activeFilter = a, this.fire("activeFilterChange"), a === this.filter ? this.setActiveEnterMode(null, null) : this.setActiveEnterMode(a.getAllowedEnterMode(this.enterMode), a.getAllowedEnterMode(this.shiftEnterMode, !0)))
            ...
            function (a, b, c) {
                if (b.delayIfDetached_callback) CKEDITOR.warn("editor-delayed-creation", { method: "callback" }), b.delayIfDetached_callback(function () { CKEDITOR[c](a, b); CKEDITOR.warn("editor-delayed-creation-success", { method: "callback" }) }); else {
                    var d = void 0 === b.delayIfDetached_interval ? CKEDITOR.config.delayIfDetached_interval : b.delayIfDetached_interval, e; CKEDITOR.warn("editor-delayed-creation", { method: "interval - " + d + " ms" }); e = setInterval(function () {
                        a.isDetached() || (clearInterval(e), CKEDITOR[c](a, b), CKEDITOR.warn("editor-delayed-creation-success",
                ...
                a && (a.delayIfDetached = "boolean" === typeof a.delayIfDetached ? a.delayIfDetached : CKEDITOR.config.delayIfDetached, a.delayIfDetached_interval = isNaN(a.delayIfDetached_interval) ? CKEDITOR.config.delayIfDetached_interval : a.delayIfDetached_interval, a.delayIfDetached_callback =
                    a.delayIfDetached_callback || CKEDITOR.config.delayIfDetached_callback)
            }
    ...
    (function () {
        function a(a) { return a.attributes["data-cke-survive"] ? !1 : "a" == a.name && a.attributes.href || CKEDITOR.dtd.$removeEmpty[a.name] } var d = CKEDITOR.tools.extend({ table: 1, ul: 1, ol: 1, dl: 1 }, CKEDITOR.dtd.table, CKEDITOR.dtd.ul, CKEDITOR.dtd.ol, CKEDITOR.dtd.dl), b = { ol: 1, ul: 1 }, c = CKEDITOR.tools.extend({}, { html: 1 }, CKEDITOR.dtd.html, CKEDITOR.dtd.body, CKEDITOR.dtd.head, { style: 1, script: 1 }), f = { ul: "li", ol: "li", dl: "dd", table: "tbody", tbody: "tr", thead: "tr", tfoot: "tr", tr: "td" }; CKEDITOR.htmlParser.fragment.fromHtml =
            function (e, k, h) {
                function l(a) { var b; if (0 < m.length) for (var c = 0; c < m.length; c++) { var d = m[c], e = d.name, f = CKEDITOR.dtd[e], g = v.name && CKEDITOR.dtd[v.name]; g && !g[e] || a && f && !f[a] && CKEDITOR.dtd[a] ? e == v.name && (w(v, v.parent, 1), c--) : (b || (r(), b = 1), d = d.clone(), d.parent = v, v = d, m.splice(c, 1), c--) } } function r() { for (; M.length;)w(M.shift(), v) } function g(a) {
                ...
                } function w(b, c, d) { c = c || v || t; var e = v; void 0 === b.previous && (y(c, b) && (v = c, A.onTagOpen(h, {}), b.returnPoint = c = v), g(b), a(b) && !b.children.length || c.add(b), "pre" == b.name && (E = !1), "textarea" == b.name && (J = !1)); b.returnPoint ? (v = b.returnPoint, delete b.returnPoint) : v = d ? c : e } function y(a, b) {
                    if ((a == t || "body" == a.name) && h && (!a.name || CKEDITOR.dtd[a.name][h])) {
                ...
                } function z(a, b) { return a in CKEDITOR.dtd.$listItem || a in CKEDITOR.dtd.$tableContent ? a == b || "dt" == a && "dd" == b || "dd" == a && "dt" == b : !1 } var A = new CKEDITOR.htmlParser, t = k instanceof CKEDITOR.htmlParser.element ? k : "string" == typeof k ? new CKEDITOR.htmlParser.element(k) : new CKEDITOR.htmlParser.fragment, m = [], M = [], v = t, J = "textarea" == t.name, E = "pre" == t.name; A.onTagOpen = function (e, f, g, h) {
                    f = new CKEDITOR.htmlParser.element(e, f); f.isUnknown && g && (f.isEmpty = !0); f.isOptionalClose = h;
                    if (a(f)) m.push(f); else {
                        if ("pre" == e) E = !0; else { if ("br" == e && E) { v.add(new CKEDITOR.htmlParser.text("\n")); return } "textarea" == e && (J = !0) } if ("br" == e) M.push(f); else {
                            for (; !(h = (g = v.name) ? CKEDITOR.dtd[g] || (v._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, f.isUnknown || v.isUnknown || h[e]);)if (v.isOptionalClose) A.onTagClose(g); else if (e in b && g in b) g = v.children, (g = g[g.length - 1]) && "li" == g.name || w(g = new CKEDITOR.htmlParser.element("li"), v), !f.returnPoint && (f.returnPoint = v), v = g; else if (e in CKEDITOR.dtd.$listItem &&
                                !z(e, g)) A.onTagOpen("li" == e ? "ul" : "dl", {}, 0, 1); else if (g in d && !z(e, g)) !f.returnPoint && (f.returnPoint = v), v = v.parent; else if (g in CKEDITOR.dtd.$inline && m.unshift(v), v.parent) w(v, v.parent, 1); else { f.isOrphan = 1; break } l(e); r(); f.parent = v; f.isEmpty ? w(f) : v = f
                        }
                    }
                }; A.onTagClose = function (a) {
                    for (var b = m.length - 1; 0 <= b; b--)if (a == m[b].name) { m.splice(b, 1); return } for (var c = [], d = [], e = v; e != t && e.name != a;)e._.isBlockLike || d.unshift(e), c.push(e), e = e.returnPoint || e.parent; if (e != t) {
                        for (b = 0; b < c.length; b++) { var f = c[b]; w(f, f.parent) } v =
                            e; e._.isBlockLike && r(); w(e, e.parent); e == v && (v = v.parent); m = m.concat(d)
                    } "body" == a && (h = !1)
                }; A.onText = function (a) { if (!(v._.hasInlineStarted && !M.length || E || J) && (a = CKEDITOR.tools.ltrim(a), 0 === a.length)) return; var b = v.name, e = b ? CKEDITOR.dtd[b] || (v._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c; if (!J && !e["#"] && b in d) A.onTagOpen(f[b] || ""), A.onText(a); else { r(); l(); E || J || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " ")); a = new CKEDITOR.htmlParser.text(a); if (y(v, a)) this.onTagOpen(h, {}, 0, 1); v.add(a) } }; A.onCDATA =
                    function (a) { v.add(new CKEDITOR.htmlParser.cdata(a)) }; A.onComment = function (a) { r(); l(); v.add(new CKEDITOR.htmlParser.comment(a)) }; A.parse(e); for (r(); v != t;)w(v, v.parent, 1); g(t); return t
        ...
        function a() { this.rules = [] } function d(b, c, d, e) { var k, h; for (k in c) (h = b[k]) || (h = b[k] = new a), h.add(c[k], d, e) } CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass({
            ...
            add: function (a, c, d) { this.rules.splice(this.findIndex(c), 0, { value: a, priority: c, options: d }) }, addMany: function (a,
                c, d) { for (var e = [this.findIndex(c), 0], k = 0, h = a.length; k < h; k++)e.push({ value: a[k], priority: c, options: d }); this.rules.splice.apply(this.rules, e) }, findIndex: function (a) { for (var c = this.rules, d = c.length - 1; 0 <= d && a < c[d].priority;)d--; return d + 1 }, exec: function (a, c) {
                    var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment, e = Array.prototype.slice.call(arguments, 1), k = this.rules, h = k.length, l, r, g, w; for (w = 0; w < h; w++)if (d && (l = c.type, r = c.name), g = k[w], !(a.nonEditable && !g.options.applyToAll ||
                        a.nestedEditable && g.options.excludeNestedEditable)) { g = g.value.apply(null, e); if (!1 === g || d && g && (g.name != r || g.type != l)) return g; null != g && (e[0] = c = g) } return c
    ...
    (function () {
        function a(a, d) {
            function g(a) { return a || CKEDITOR.env.needsNbspFiller ? new CKEDITOR.htmlParser.text(" ") : new CKEDITOR.htmlParser.element("br", { "data-cke-bogus": 1 }) } function p(a, d) {
                return function (f) {
                    if (f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var n = [], p = b(f), B, h; if (p) for (q(p, 1) && n.push(p); p;)e(p) && (B = c(p)) && q(B) && ((h = c(B)) && !e(h) ? n.push(B) : (g(D).insertAfter(B), B.remove())), p = p.previous; for (p = 0; p < n.length; p++)n[p].remove(); if (n = !a || !1 !== ("function" == typeof d ? d(f) : d)) D || CKEDITOR.env.needsBrFiller ||
                ...
                if ((!D || CKEDITOR.env.needsBrFiller) && a.type == CKEDITOR.NODE_ELEMENT && "br" == a.name && !a.attributes["data-cke-eol"]) return !0; var c; return a.type == CKEDITOR.NODE_TEXT && (c = a.value.match(M)) && (c.index && ((new CKEDITOR.htmlParser.text(a.value.substring(0, c.index))).insertBefore(a),
                    a.value = c[0]), !CKEDITOR.env.needsBrFiller && D && (!b || a.parent.name in h) || !D && ((c = a.previous) && "br" == c.name || !c || e(c))) ? !0 : !1
            } var B = { elements: {} }, D = "html" == d, h = CKEDITOR.tools.extend({}, u), x; for (x in h) "#" in J[x] || delete h[x]; for (x in h) B.elements[x] = p(D, a.config.fillEmptyBlocks); B.root = p(D, !1); B.elements.br = function (a) {
                return function (b) {
            ...
            return a &&
                (a.type == CKEDITOR.NODE_ELEMENT && a.name in u || a.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT)
        } function k(a, b) { var c = a.children[a.children.length - 1]; a.children.push(b); b.parent = a; c && (c.next = b, b.previous = c) } function h(a) { a = a.attributes; "false" != a.contenteditable && (a["data-cke-editable"] = a.contenteditable ? "true" : 1); a.contenteditable = "false" } function l(a) { a = a.attributes; switch (a["data-cke-editable"]) { case "true": a.contenteditable = "true"; break; case "1": delete a.contenteditable } } function r(a, b) {
            return a.replace(p,
                function (a, c, d) { return "\x3c" + c + d.replace(D, function (a, c) { return B.test(c) && -1 == d.indexOf("data-cke-saved-" + c) ? " data-cke-saved-" + a + " data-cke-" + b + "-" + a : a }) + "\x3e" })
        } function g(a, b) { return a.replace(b, function (a, b, c) { 0 === a.indexOf("\x3ctextarea") && (a = b + z(c).replace(/</g, "\x26lt;").replace(/>/g, "\x26gt;") + "\x3c/textarea\x3e"); return "\x3ccke:encoded\x3e" + encodeURIComponent(a) + "\x3c/cke:encoded\x3e" }) } function w(a) { return a.replace(O, function (a, b) { return decodeURIComponent(b) }) } function y(a) {
            return a.replace(/\x3c!--(?!{cke_protected})[\s\S]+?--\x3e/g,
                function (a) { return "\x3c!--" + v + "{C}" + encodeURIComponent(a).replace(/--/g, "%2D%2D") + "--\x3e" })
        } function z(a) { return a.replace(/\x3c!--\{cke_protected\}\{C\}([\s\S]+?)--\x3e/g, function (a, b) { return decodeURIComponent(b) }) } function A(a, b) { var c = b._.dataStore; return a.replace(/\x3c!--\{cke_protected\}([\s\S]+?)--\x3e/g, function (a, b) { return decodeURIComponent(b) }).replace(/\{cke_protected_(\d+)\}/g, function (a, b) { return c && c[b] || "" }) } function t(a, b, c) {
            var d = [], e = b.config.protectedSource, f = b._.dataStore ||
                (b._.dataStore = { id: 1 }), g = new RegExp("\x3c\\!--\\{cke_temp_" + c + "(comment)?\\}(\\d*?)--\x3e", "g"), e = [/<script[\s\S]*?(<\/script>|$)/gi, /<noscript[\s\S]*?<\/noscript>/gi, /<meta[\s\S]*?\/?>/gi].concat(e); a = a.replace(/\x3c!--[\s\S]*?--\x3e/g, function (a) { return "\x3c!--{cke_temp_" + c + "comment}" + (d.push(a) - 1) + "--\x3e" }); for (var p = 0; p < e.length; p++)a = a.replace(e[p], function (a) { a = a.replace(g, function (a, b, c) { return d[c] }); return g.test(a) ? a : "\x3c!--{cke_temp_" + c + "}" + (d.push(a) - 1) + "--\x3e" }); a = a.replace(g, function (a,
                    b, c) { return "\x3c!--" + v + (b ? "{C}" : "") + encodeURIComponent(d[c]).replace(/--/g, "%2D%2D") + "--\x3e" }); a = a.replace(/<\w+(?:\s+(?:(?:[^\s=>]+\s*=\s*(?:[^'"\s>]+|'[^']*'|"[^"]*"))|[^\s=\/>]+))+\s*\/?>/g, function (a) { return a.replace(/\x3c!--\{cke_protected\}([^>]*)--\x3e/g, function (a, b) { f[f.id] = decodeURIComponent(b); return "{cke_protected_" + f.id++ + "}" }) }); return a = a.replace(/<(title|iframe|textarea)([^>]*)>([\s\S]*?)<\/\1>/g, function (a, c, d, e) { return "\x3c" + c + d + "\x3e" + A(z(e), b) + "\x3c/" + c + "\x3e" })
            ...
            function (b) {
                var c, e, f = this; this.editor = b; this.dataFilter = c = new CKEDITOR.htmlParser.filter; this.htmlFilter = e = new CKEDITOR.htmlParser.filter; this.writer = new CKEDITOR.htmlParser.basicWriter; c.addRules(F); c.addRules(H, { applyToAll: !0 }); c.addRules(a(b, "data"), { applyToAll: !0 }); e.addRules(x); e.addRules(K, { applyToAll: !0 }); e.addRules(a(b, "html"), { applyToAll: !0 }); b.on("toHtml", function (a) {
                    ...
                    a = a.data; var e = a.dataValue, e = m(e), e = t(e, b, c), e = g(e, T), e = r(e, c), e = g(e, G), e = e.replace(q, "$1cke:$2"), e = e.replace(N, "\x3ccke:$1$2\x3e\x3c/cke:$1\x3e"), e = e.replace(/(<pre\b[^>]*>)(\r\n|\n)/g, "$1$2$2"), e = e.replace(/([^a-z0-9<\-])(on\w{3,})(?!>)/gi, "$1data-cke-" + c + "-$2"), f = a.context || b.editable().getName(), p; CKEDITOR.env.ie && 9 > CKEDITOR.env.version && "pre" == f && (f = "div", e = "\x3cpre\x3e" + e + "\x3c/pre\x3e", p = 1); f = b.document.createElement(f); f.setHtml("a" + e); e = f.getHtml().substr(1); e = e.replace(new RegExp("data-cke-" +
                        c + "-", "ig"), ""); p && (e = e.replace(/^<pre>|<\/pre>$/gi, "")); e = e.replace(I, "$1$2"); e = w(e); e = z(e); c = !1 === a.fixForBody ? !1 : d(a.enterMode, b.config.autoParagraph); e = CKEDITOR.htmlParser.fragment.fromHtml(e, a.context, c); c && (p = e, !p.children.length && CKEDITOR.dtd[p.name][c] && (c = new CKEDITOR.htmlParser.element(c), p.add(c))); a.dataValue = e
                    ...
                    a.data.dataValue.filterChildren(f.htmlFilter,
                        !0)
                }, null, null, 10); b.on("toDataFormat", function (a) { a.data.filter.applyTo(a.data.dataValue, !1, !0) }, null, null, 11); b.on("toDataFormat", function (a) { var c = a.data.dataValue, d = f.writer; d.reset(); c.writeChildrenHtml(d); c = d.getHtml(!0); c = z(c); c = A(c, b); a.data.dataValue = c }, null, null, 15)
            }; CKEDITOR.htmlDataProcessor.prototype = {
                toHtml: function (a, b, c, d) {
                    var e = this.editor, f, g, p, q; b && "object" == typeof b ? (f = b.context, c = b.fixForBody, d = b.dontFilter, g = b.filter, p = b.enterMode, q = b.protectedWhitespaces) : f = b; f || null === f || (f =
                        e.editable().getName()); return e.fire("toHtml", { dataValue: a, context: f, fixForBody: c, dontFilter: d, filter: g || e.filter, enterMode: p || e.enterMode, protectedWhitespaces: q }).dataValue
                }, toDataFormat: function (a, b) { var c, d, e; b && (c = b.context, d = b.filter, e = b.enterMode); c || null === c || (c = this.editor.editable().getName()); return this.editor.fire("toDataFormat", { dataValue: a, filter: d || this.editor.filter, context: c, enterMode: e || this.editor.enterMode }).dataValue }, protectSource: function (a) { return t(a, this.editor) }, unprotectSource: function (a) {
                    return A(a,
                        this.editor)
                }, unprotectRealComments: function (a) { return z(a) }
            }; var M = /(?:&nbsp;|\xa0)$/, v = "{cke_protected}", J = CKEDITOR.dtd, E = "caption colgroup col thead tfoot tbody".split(" "), u = CKEDITOR.tools.extend({}, J.$blockLimit, J.$block), F = { elements: { input: h, textarea: h } }, H = {
            ...
            }, x = { elements: { embed: function (a) { var b = a.parent; if (b && "object" == b.name) { var c = b.attributes.width, b = b.attributes.height; c && (a.attributes.width = c); b && (a.attributes.height = b) } }, a: function (a) { var b = a.attributes; if (!(a.children.length || b.name || b.id || a.attributes["data-cke-saved-name"])) return !1 } } }, K = {
            ...
            }; CKEDITOR.env.ie && (K.attributes.style = function (a) { return a.replace(/(^|;)([^\:]+)/g, function (a) { return a.toLowerCase() }) }); var p = /<(a|area|img|input|source)\b([^>]*)>/gi, D = /([\w-:]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, B = /^(href|src|name)$/i, G = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi, T = /(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi,
                O = /<cke:encoded>([^<]*)<\/cke:encoded>/gi, q = /(<\/?)((?:object|embed|param|html|body|head|title)([\s][^>]*)?>)/gi, I = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, N = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi; m = function () {
    ...
    (function () {
        function a(a, f, e, k) {
            ...
            var b = a.name, d =
                a.element, k = a.elementMode, h = a.fire("uiSpace", { space: "top", html: "" }).html, l = a.fire("uiSpace", { space: "bottom", html: "" }).html, r = new CKEDITOR.template('\x3c{outerEl} id\x3d"cke_{name}" class\x3d"{id} cke cke_reset cke_chrome cke_editor_{name} cke_{langDir} ' + CKEDITOR.env.cssClass + '"  dir\x3d"{langDir}" lang\x3d"{langCode}" role\x3d"application"' + (a.title ? ' aria-labelledby\x3d"cke_{name}_arialbl"' : "") + "\x3e" + (a.title ? '\x3cspan id\x3d"cke_{name}_arialbl" class\x3d"cke_voice_label"\x3e{voiceLabel}\x3c/span\x3e' :
                    "") + '\x3c{outerEl} class\x3d"cke_inner cke_reset" role\x3d"presentation"\x3e{topHtml}\x3c{outerEl} id\x3d"{contentId}" class\x3d"cke_contents cke_reset" role\x3d"presentation"\x3e\x3c/{outerEl}\x3e{bottomHtml}\x3c/{outerEl}\x3e\x3c/{outerEl}\x3e'), b = CKEDITOR.dom.element.createFromHtml(r.output({
            ...
            var d = this, k = this._.modes; if (a != d.mode && k && k[a]) {
                d.fire("beforeSetMode", a); if (d.mode) {
                    var h = d.checkDirty(), k = d._.previousModeData, l, r = 0; d.fire("beforeModeUnload");
                    d.editable(0); d._.previousMode = d.mode; d._.previousModeData = l = d.getData(1); "source" == d.mode && k == l && (d.fire("lockSnapshot", { forceUpdate: !0 }), r = 1); d.ui.space("contents").setHtml(""); d.mode = ""
                } else d._.previousModeData = d.getData(1); this._.modes[a](function () { d.mode = a; void 0 !== h && !h && d.resetDirty(); r ? d.fire("unlockSnapshot") : "wysiwyg" == a && d.fire("saveSnapshot"); setTimeout(function () { d.isDestroyed() || d.isDetached() || (d.fire("mode"), b && b.call(d)) }, 0) })
            }
        }; CKEDITOR.editor.prototype.resize = function (a, b, d, k) {
            var h =
                this.container, l = this.ui.space("contents"), r = CKEDITOR.env.webkit && this.document && this.document.getWindow().$.frameElement; k = k ? this.container.getFirst(function (a) { return a.type == CKEDITOR.NODE_ELEMENT && a.hasClass("cke_inner") }) : h; if (a || 0 === a) a = CKEDITOR.tools.convertToPx(CKEDITOR.tools.cssLength(a)); k.setSize("width", a, !0); r && (r.style.width = "1%"); b = CKEDITOR.tools.convertToPx(CKEDITOR.tools.cssLength(b)); var g = (k.$.offsetHeight || 0) - (l.$.clientHeight || 0), h = Math.max(b - (d ? 0 : g), 0); b = d ? b + g : b; l.setStyle("height",
                    CKEDITOR.tools.cssLength(h)); r && (r.style.width = "100%"); this.fire("resize", { outerHeight: b, contentsHeight: h, outerWidth: a || k.getSize("width") })
    ...
    (function () {
        ...
        function l(a, b, c) { return !1 !== a.config.autoParagraph && a.activeEnterMode != CKEDITOR.ENTER_BR && (a.editable().equals(c) && !b || b && "true" == b.getAttribute("contenteditable")) } function r(a) { return a.activeEnterMode != CKEDITOR.ENTER_BR && !1 !== a.config.autoParagraph ? a.activeEnterMode == CKEDITOR.ENTER_DIV ? "div" : "p" : !1 } function g(a) { a && a.isEmptyInlineRemoveable() && a.remove() } function w(a) { var b = a.editor; b.getSelection().scrollIntoView(); setTimeout(function () { b.fire("saveSnapshot") }, 0) } function y(a, b, c) {
            var d = a.getCommonAncestor(b);
            for (b = a = c ? b : a; (a = a.getParent()) && !d.equals(a) && 1 == a.getChildCount();)b = a; b.remove()
        } var z, A, t, m, M, v, J, E, u, F, H = { ul: 1, ol: 1, dl: 1 }; CKEDITOR.editable = CKEDITOR.tools.createClass({
            base: CKEDITOR.dom.element, $: function (a, b) { this.base(b.$ || b); this.editor = a; this.status = "unloaded"; this.hasFocus = !1; this.setup() }, proto: {
                ...
                restoreAttrs: function () { var a = this._.attrChanges, b, c; for (c in a) a.hasOwnProperty(c) && (b = a[c], null !== b ? this.setAttribute(c, b) : this.removeAttribute(c)) }, attachClass: function (a) { var b = this.getCustomData("classes"); this.hasClass(a) || (!b && (b = []), b.push(a), this.setCustomData("classes", b), this.addClass(a)) }, changeAttr: function (a, b) { var c = this.getAttribute(a); b !== c && (!this._.attrChanges && (this._.attrChanges = {}), a in this._.attrChanges || (this._.attrChanges[a] = c), this.setAttribute(a, b)) }, insertText: function (a) {
                    ...
                    var d = this.editor; d.focus(); d.fire("saveSnapshot"); var e = d.activeEnterMode, d = d.getSelection(), g = a.getName(), g = CKEDITOR.dtd.$block[g]; b || (b = d.getRanges()[0]); this.insertElementIntoRange(a, b) && (b.moveToPosition(a, CKEDITOR.POSITION_AFTER_END), g && ((g = a.getNext(function (a) { return c(a) && !m(a) })) && g.type == CKEDITOR.NODE_ELEMENT && g.is(CKEDITOR.dtd.$block) ? g.getDtd()["#"] ? b.moveToElementEditStart(g) : b.moveToElementEditEnd(a) :
                        g || e == CKEDITOR.ENTER_BR || (g = b.fixBlock(!0, e == CKEDITOR.ENTER_DIV ? "div" : "p"), b.moveToElementEditStart(g)))); d.selectRanges([b]); w(this)
                    ...
                    var c = this.editor, d = c.config.enterMode, e = a.getName(), f = CKEDITOR.dtd.$block[e]; if (b.checkReadOnly()) return !1; b.deleteContents(1); b.startContainer.type == CKEDITOR.NODE_ELEMENT && (b.startContainer.is({ tr: 1, table: 1, tbody: 1, thead: 1, tfoot: 1 }) ? J(b) : b.startContainer.is(CKEDITOR.dtd.$list) &&
                        E(b)); var h, k; if (f) for (; (h = b.getCommonAncestor(0, 1)) && (k = CKEDITOR.dtd[h.getName()]) && (!k || !k[e]);)if (h.getName() in CKEDITOR.dtd.span) { var f = b.splitElement(h), q = b.createBookmark(); g(h); g(f); b.moveToBookmark(q) } else b.checkStartOfBlock() && b.checkEndOfBlock() ? (b.setStartBefore(h), b.collapse(!0), h.remove()) : b.splitBlock(d == CKEDITOR.ENTER_DIV ? "div" : "p", c.editable()); b.insertNode(a); return !0
                    ...
                    this.status = "detached"; this.editor.setData(this.editor.getData(), { internal: !0 }); this.clearListeners(); try { this._.cleanCustomData() } catch (a) { if (!CKEDITOR.env.ie || -2146828218 !== a.number) throw a; } this.editor.fire("contentDomUnload"); delete this.editor.document;
                    delete this.editor.window; delete this.editor
                        ...
                        "beforeFocus", function () { var b = a.getSelection(); (b = b && b.getNative()) && "Control" == b.type || this.focus() }, this); this.attachListener(a, "insertHtml", function (a) { this.insertHtml(a.data.dataValue, a.data.mode, a.data.range) }, this); this.attachListener(a, "insertElement", function (a) { this.insertElement(a.data) }, this); this.attachListener(a, "insertText", function (a) { this.insertText(a.data) }, this); this.setReadOnly(a.readOnly); this.attachClass("cke_editable"); a.elementMode == CKEDITOR.ELEMENT_MODE_INLINE ? this.attachClass("cke_editable_inline") :
                            a.elementMode != CKEDITOR.ELEMENT_MODE_REPLACE && a.elementMode != CKEDITOR.ELEMENT_MODE_APPENDTO || this.attachClass("cke_editable_themed"); this.attachClass("cke_contents_" + a.config.contentsLangDirection); a.keystrokeHandler.blockedKeystrokes[8] = +a.readOnly; a.keystrokeHandler.attach(this); this.on("blur", function () { this.hasFocus = !1 }, null, null, -1); this.on("focus", function () { this.hasFocus = !0 }, null, null, -1); if (CKEDITOR.env.webkit) this.on("scroll", function () { a._.previousScrollTop = a.editable().$.scrollTop }, null,
                                null, -1); if (CKEDITOR.env.edge && 14 < CKEDITOR.env.version) { var d = function () { var b = a.editable(); null != a._.previousScrollTop && b.getDocument().equals(CKEDITOR.document) && (b.$.scrollTop = a._.previousScrollTop, a._.previousScrollTop = null, this.removeListener("scroll", d)) }; this.on("scroll", d) } a.focusManager.add(this); this.equals(CKEDITOR.document.getActive()) && (this.hasFocus = !0, a.once("contentDom", function () { a.focusManager.focus(this) }, this)); this.isInline() && this.changeAttr("tabindex", a.tabIndex); if (!this.is("textarea")) {
                                    a.document =
                                    this.getDocument(); a.window = this.getWindow(); var g = a.document; this.changeAttr("spellcheck", !a.config.disableNativeSpellChecker); var f = a.config.contentsLangDirection; this.getDirection(1) != f && this.changeAttr("dir", f); var B = CKEDITOR.getCss(); if (B) {
                                        var f = g.getHead(), G = f.getCustomData("stylesheet"); G ? B != G.getText() && (CKEDITOR.env.ie && 9 > CKEDITOR.env.version ? G.$.styleSheet.cssText = B : G.setText(B)) : (B = g.appendStyleText(B), B = new CKEDITOR.dom.element(B.ownerNode || B.owningElement), f.setCustomData("stylesheet",
                                            B), B.data("cke-temp", 1))
                                        ...
                                        if (a.readOnly) return !0; var c = b.data.domEvent.getKey(), d, g = a.getSelection(); if (0 !== g.getRanges().length) {
                                            if (c in
                                                l) {
                                                    var f; b = g.getRanges()[0]; var p = b.startPath(), B, D, G, c = 8 == c, r = !1; if (CKEDITOR.env.ie && 11 > CKEDITOR.env.version && g.getSelectedElement()) f = g.getSelectedElement(); else if (e(g)) {
                                                        var m = new CKEDITOR.dom.walker(b), w = b.collapsed ? b.startContainer : m.next(), r = !1, K; if (b.checkStartOfBlock()) { K = b.startPath().block || b.startPath().blockLimit; var t = K.getName(); K = -1 !== CKEDITOR.tools.array.indexOf(["dd", "dt", "li"], t) && null === K.getPrevious() } else K = !1; if (K) {
                                                            for (; w && !r;)r = w.$.nodeName.toLowerCase(), r = !!H[r], w = m.next();
                                                            m = h(b.startPath()); w = h(b.endPath()); r = r || m !== w
                                                        } else r = void 0; r || (f = k(g))
            ...
            function () {
                function a(b) { return b.type == CKEDITOR.NODE_ELEMENT } function b(c, d) {
                    var e, g, f, q, h = [], p = d.range.startContainer; e = d.range.startPath(); for (var p = m[p.getName()], k = 0, B = c.getChildren(), D = B.count(), G = -1, l = -1, I = 0, N = e.contains(m.$list); k < D; ++k)e = B.getItem(k), a(e) ? (f = e.getName(), N && f in CKEDITOR.dtd.$list ? h = h.concat(b(e, d)) : (q = !!p[f], "br" != f || !e.data("cke-eol") || k && k != D - 1 || (I = (g = k ? h[k - 1].node : B.getItem(k + 1)) && (!a(g) || !g.is("br")), g = g && a(g) && m.$block[g.getName()]), -1 != G || q || (G = k), q || (l = k), h.push({
                        isElement: 1,
                        isLineBreak: I, isBlock: e.isBlockBoundary(), hasBlockSibling: g, node: e, name: f, allowed: q
                    }), g = I = 0)) : h.push({ isElement: 0, node: e, allowed: 1 }); -1 < G && (h[G].firstNotAllowed = 1); -1 < l && (h[l].lastNotAllowed = 1); return h
                } function d(b, c) { var e = [], g = b.getChildren(), f = g.count(), q, h = 0, k = m[c], B = !b.is(m.$inline) || b.is("br"); for (B && e.push(" "); h < f; h++)q = g.getItem(h), a(q) && !q.is(k) ? e = e.concat(d(q, c)) : e.push(q); B && e.push(" "); return e } function e(b) { return a(b.startContainer) && b.startContainer.getChild(b.startOffset - 1) } function f(b) {
                    return b &&
                        a(b) && (b.is(m.$removeEmpty) || b.is("a") && !b.isBlockBoundary())
                } function h(b, c, d, e) { var g = b.clone(), f, p; g.setEndAt(c, CKEDITOR.POSITION_BEFORE_END); (f = (new CKEDITOR.dom.walker(g)).next()) && a(f) && q[f.getName()] && (p = f.getPrevious()) && a(p) && !p.getParent().equals(b.startContainer) && d.contains(p) && e.contains(f) && f.isIdentical(p) && (f.moveChildren(p), f.remove(), h(b, c, d, e)) } function k(b, c) {
                ...
                } var m = CKEDITOR.dtd, q = { p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, ul: 1, ol: 1, li: 1, pre: 1, dl: 1, blockquote: 1 }, I = { p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1 }, N = CKEDITOR.tools.extend({}, m.$inline); delete N.br; return function (q, C, L, w) {
                    var t = q.editor, u = !1, y; "unfiltered_html" == C && (C = "html", u = !0); if (!w.checkReadOnly()) {
                        var z = (new CKEDITOR.dom.elementPath(w.startContainer, w.root)).blockLimit ||
                            w.root; C = { type: C, dontFilter: u, editable: q, editor: t, range: w, blockLimit: z, mergeCandidates: [], zombies: [] }; var u = C.range, z = C.mergeCandidates, v = "html" === C.type, A, S, V, F, H; "text" == C.type && u.shrink(CKEDITOR.SHRINK_ELEMENT, !0, !1) && (S = CKEDITOR.dom.element.createFromHtml("\x3cspan\x3e\x26nbsp;\x3c/span\x3e", u.document), u.insertNode(S), u.setStartAfter(S)); V = new CKEDITOR.dom.elementPath(u.startContainer); C.endPath = F = new CKEDITOR.dom.elementPath(u.endContainer); if (!u.collapsed) {
                                A = F.block || F.blockLimit; var Z = u.getCommonAncestor();
                                A && !A.equals(Z) && !A.contains(Z) && u.checkEndOfBlock() && C.zombies.push(A); u.deleteContents()
                            } for (; (H = e(u)) && a(H) && H.isBlockBoundary() && V.contains(H);)u.moveToPosition(H, CKEDITOR.POSITION_BEFORE_END); h(u, C.blockLimit, V, F); S && (u.setEndBefore(S), u.collapse(), S.remove()); S = u.startPath(); if (A = S.contains(f, !1, 1)) y = u.splitElement(A), C.inlineStylesRoot = A, C.inlineStylesPeak = S.lastElement; S = u.createBookmark(); v && (g(A), g(y)); (A = S.startNode.getPrevious(c)) && a(A) && f(A) && z.push(A); (A = S.startNode.getNext(c)) && a(A) &&
                                f(A) && z.push(A); for (A = S.startNode; (A = A.getParent()) && f(A);)z.push(A); u.moveToBookmark(S); y = q.getHtml(); y = "" === y || y.match(M); t.enterMode === CKEDITOR.ENTER_DIV && y && ((t = q.getFirst()) && t.remove(), w.setStartAt(q, CKEDITOR.POSITION_AFTER_START), w.collapse(!0)); if (q = L) {
                                    q = C.range; if ("text" == C.type && C.inlineStylesRoot) { w = C.inlineStylesPeak; t = w.getDocument().createText("{cke-peak}"); for (y = C.inlineStylesRoot.getParent(); !w.equals(y);)t = t.appendTo(w.clone()), w = w.getParent(); L = t.getOuterHtml().split("{cke-peak}").join(L) } w =
                                        C.blockLimit.getName(); if (/^\s+|\s+$/.test(L) && "span" in CKEDITOR.dtd[w]) { var J = '\x3cspan data-cke-marker\x3d"1"\x3e\x26nbsp;\x3c/span\x3e'; L = J + L + J } L = C.editor.dataProcessor.toHtml(L, { context: null, fixForBody: !1, protectedWhitespaces: !!J, dontFilter: C.dontFilter, filter: C.editor.activeFilter, enterMode: C.editor.activeEnterMode }); w = q.document.createElement("body"); w.setHtml(L); J && (w.getFirst().remove(), w.getLast().remove()); if ((J = q.startPath().block) && (1 != J.getChildCount() || !J.getBogus())) a: {
                                            var Q; if (1 ==
                                                w.getChildCount() && a(Q = w.getFirst()) && Q.is(I) && !Q.hasAttribute("contenteditable")) { J = Q.getElementsByTag("*"); q = 0; for (y = J.count(); q < y; q++)if (t = J.getItem(q), !t.is(N)) break a; Q.moveChildren(Q.getParent(1)); Q.remove() }
                                        } C.dataWrapper = w; q = L
                                } if (q) {
                                    Q = C.range; q = Q.document; w = C.blockLimit; y = 0; var E, J = [], ca, P; L = S = 0; var U, t = Q.startContainer; H = C.endPath.elements[0]; var R, u = H.getPosition(t), z = !!H.getCommonAncestor(t) && u != CKEDITOR.POSITION_IDENTICAL && !(u & CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED),
                                        t = b(C.dataWrapper, C); for (C.editor.enterMode !== CKEDITOR.ENTER_BR && k(t, Q); y < t.length; y++) {
                                            u = t[y]; if (v = u.isLineBreak) v = Q, A = w, F = V = void 0, u.hasBlockSibling ? v = 1 : (V = v.startContainer.getAscendant(m.$block, 1)) && V.is({ div: 1, p: 1 }) ? (F = V.getPosition(A), F == CKEDITOR.POSITION_IDENTICAL || F == CKEDITOR.POSITION_CONTAINS ? v = 0 : (A = v.splitElement(V), v.moveToPosition(A, CKEDITOR.POSITION_AFTER_START), v = 1)) : v = 0; if (v) L = 0 < y; else {
                                                v = Q.startPath(); !u.isBlock && l(C.editor, v.block, v.blockLimit) && (P = r(C.editor)) && (P = q.createElement(P),
                                                    P.appendBogus(), Q.insertNode(P), CKEDITOR.env.needsBrFiller && (E = P.getBogus()) && E.remove(), Q.moveToPosition(P, CKEDITOR.POSITION_BEFORE_END)); if ((v = Q.startPath().block) && !v.equals(ca)) { if (E = v.getBogus()) E.remove(), J.push(v); ca = v } u.firstNotAllowed && (S = 1); if (S && u.isElement) {
                                                        v = Q.startContainer; for (A = null; v && !m[v.getName()][u.name];) { if (v.equals(w)) { v = null; break } A = v; v = v.getParent() } if (v) A && (U = Q.splitElement(A), C.zombies.push(U), C.zombies.push(A)); else {
                                                            A = w.getName(); R = !y; v = y == t.length - 1; A = d(u.node, A); V = [];
                                                            F = A.length; for (var Z = 0, Y = void 0, da = 0, fa = -1; Z < F; Z++)Y = A[Z], " " == Y ? (da || R && !Z || (V.push(new CKEDITOR.dom.text(" ")), fa = V.length), da = 1) : (V.push(Y), da = 0); v && fa == V.length && V.pop(); R = V
                                                        }
                                                    } if (R) { for (; v = R.pop();)Q.insertNode(v); R = 0 } else Q.insertNode(u.node); u.lastNotAllowed && y < t.length - 1 && ((U = z ? H : U) && Q.setEndAt(U, CKEDITOR.POSITION_AFTER_START), S = 0); Q.collapse()
                                            }
                                        } 1 != t.length ? E = !1 : (E = t[0], E = E.isElement && "false" == E.node.getAttribute("contenteditable")); E && (L = !0, v = t[0].node, Q.setStartAt(v, CKEDITOR.POSITION_BEFORE_START),
                                            Q.setEndAt(v, CKEDITOR.POSITION_AFTER_END)); C.dontMoveCaret = L; C.bogusNeededBlocks = J
                                } E = C.range; var ba; R = C.bogusNeededBlocks; for (ca = E.createBookmark(); P = C.zombies.pop();)P.getParent() && (U = E.clone(), U.moveToElementEditStart(P), U.removeEmptyBlocksAtEnd()); if (R) for (; P = R.pop();)CKEDITOR.env.needsBrFiller ? P.appendBogus() : P.append(E.document.createText(" ")); for (; P = C.mergeCandidates.pop();)P.mergeSiblings(); CKEDITOR.env.webkit && E.startPath() && (P = E.startPath(), P.block ? P.block.$.normalize() : P.blockLimit && P.blockLimit.$.normalize());
                        E.moveToBookmark(ca); if (!C.dontMoveCaret) { for (P = e(E); P && a(P) && !P.is(m.$empty);) { if (P.isBlockBoundary()) E.moveToPosition(P, CKEDITOR.POSITION_BEFORE_END); else { if (f(P) && P.getHtml().match(/(\s|&nbsp;)$/g)) { ba = null; break } ba = E.clone(); ba.moveToPosition(P, CKEDITOR.POSITION_BEFORE_END) } P = P.getLast(c) } ba && E.moveToRange(ba) }
                    }
                }
            }(); J = function () {
                function a(b) {
                ...
                function a(b, c) { var d = b.getParent(); if (d.is(CKEDITOR.dtd.$inline)) b[c ? "insertBefore" : "insertAfter"](d) } function b(c, d, e) {
                    a(d); a(e, 1); for (var g; g =
                        e.getNext();)g.insertAfter(d), d = g; t(c) && c.remove()
                    ...
                    list: {
                        ...
                        function a(c) {
                            var e = [], g, f = new CKEDITOR.dom.walker(c), h = c.startPath().contains(d), k = c.endPath().contains(d), p = {}; f.guard = function (a, f) {
                                if (a.type == CKEDITOR.NODE_ELEMENT) { var l = "visited_" + (f ? "out" : "in"); if (a.getCustomData(l)) return; CKEDITOR.dom.element.setMarker(p, a, l, 1) } if (f && h && a.equals(h)) g = c.clone(), g.setEndAt(h, CKEDITOR.POSITION_BEFORE_END), e.push(g); else if (!f && k && a.equals(k)) g = c.clone(), g.setStartAt(k,
                                    CKEDITOR.POSITION_AFTER_START), e.push(g); else { if (l = !f) l = a.type == CKEDITOR.NODE_ELEMENT && a.is(d) && (!h || b(a, h)) && (!k || b(a, k)); if (!l && (l = f)) if (a.is(d)) var l = h && h.getAscendant("table", !0), D = k && k.getAscendant("table", !0), I = a.getAscendant("table", !0), l = l && l.contains(I) || D && D.contains(I); else l = void 0; l && (g = c.clone(), g.selectNodeContents(a), e.push(g)) }
                            }; f.lastForward(); CKEDITOR.dom.element.clearAllMarkers(p); return e
                        } function b(a, c) {
                            ...
                            detectPurge: function (a) {
                                ...
                                for (var b; b = a.tableContentsRanges.pop();)b.extractContents(), t(b.startContainer) &&
                    ...
                    fixUneditableRangePosition: function (a) { a.startContainer.getDtd()["#"] || a.moveToClosestEditablePosition(null, !0) }, autoParagraph: function (a, b) { var c = b.startPath(), d; l(a, c.block, c.blockLimit) && (d = r(a)) && (d = b.document.createElement(d), d.appendBogus(), b.insertNode(d), b.moveToPosition(d, CKEDITOR.POSITION_AFTER_START)) }
                }
            }()
    })();
    (function () {
        function a(a) { return CKEDITOR.plugins.widget && CKEDITOR.plugins.widget.isDomWidget(a) } function d(b, c) {
            ...
            return c += d.join("\t")
        } function f(a) { var b = this.root.editor, d = b.getSelection(1); this.reset(); E = !0; d.root.once("selectionchange", function (a) { a.cancel() }, null, null, 0); d.selectRanges([a[0]]); d = this._.cache; d.ranges = new CKEDITOR.dom.rangeList(a); d.type = CKEDITOR.SELECTION_TEXT; d.selectedElement = a[0]._getTableElement(); d.selectedText = c(a); d.nativeSel = null; this.isFake = 1; this.rev = M++; b._.fakeSelection = this; E = !1; this.root.fire("selectionchange") } function e() {
        ...
        } function k() { F = !0; u || (h.call(this), u = CKEDITOR.tools.setTimeout(h, 200, this)) } function h() { u = null; F && (CKEDITOR.tools.setTimeout(e, 0, this), F = !1) } function l(a) { return H(a) || a.type == CKEDITOR.NODE_ELEMENT && !a.is(CKEDITOR.dtd.$empty) ? !0 : !1 } function r(a) {
        ...
        } function g(a) { w(a, !1); var b = a.getDocument().createText(v); a.setCustomData("cke-fillingChar", b); return b } function w(a, b) {
            var c = a && a.removeCustomData("cke-fillingChar"); if (c) {
                if (!1 !== b) {
                    var d = a.getDocument().getSelection().getNative(), e = d && "None" != d.type && d.getRangeAt(0), g = v.length; if (c.getLength() > g && e && e.intersectsNode(c.$)) {
        ...
        } function y(a, b) { return b ? a.replace(J, function (a, b) { return b ? " " : "" }) : a.replace(v, "") } function z(a, b) {
            ...
            "function" != typeof window.getSelection, M = 1, v = CKEDITOR.tools.repeat("​", 7), J = new RegExp(v + "( )?", "g"), E, u, F, H = CKEDITOR.dom.walker.invisible(1), x = function () {
                ...
                function b() { var a = c.getSelection(); a && a.removeAllRanges() } var c = a.editor; c.on("contentDom", function () {
                    function a() { u = new CKEDITOR.dom.selection(c.getSelection()); u.lock() } function b() {
                        h.removeListener("mouseup",
                            b); p.removeListener("mouseup", b); var a = CKEDITOR.document.$.selection, c = a.createRange(); "None" != a.type && c.parentElement() && c.parentElement().ownerDocument == f.$ && c.select()
                        ...
                        if (D && (CKEDITOR.env.webkit ||
                            CKEDITOR.env.gecko)) { D = c._.previousActive && c._.previousActive.equals(f.getActive()); var a = null != c._.previousScrollTop && c._.previousScrollTop != n.$.scrollTop; CKEDITOR.env.webkit && D && a && (n.$.scrollTop = c._.previousScrollTop) } c.unlockSelection(D); D = 0
                    }, null, null, -1); n.attachListener(n, "mousedown", function () { D = 0 }); if (CKEDITOR.env.ie || CKEDITOR.env.gecko || r) m ? n.attachListener(n, "beforedeactivate", a, null, null, -1) : n.attachListener(c, "selectionCheck", a, null, null, -1), n.attachListener(n, CKEDITOR.env.webkit || CKEDITOR.env.gecko ?
                        "focusout" : "blur", function () { var a = u && (u.isFake || 2 > u.getRanges().length); CKEDITOR.env.gecko && !r && a || (c.lockSelection(u), D = 1) }, null, null, -1), n.attachListener(n, "mousedown", function () { D = 0 }); if (CKEDITOR.env.ie && !r) {
                            var t; n.attachListener(n, "mousedown", function (a) { 2 == a.data.$.button && ((a = c.document.getSelection()) && a.getType() != CKEDITOR.SELECTION_NONE || (t = c.window.getScrollPosition())) }); n.attachListener(n, "mouseup", function (a) {
                                2 == a.data.$.button && t && (c.document.$.documentElement.scrollLeft = t.x, c.document.$.documentElement.scrollTop =
                                    t.y); t = null
                            }); if ("BackCompat" != f.$.compatMode) {
                                if (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) {
                                    var y, v; p.on("mousedown", function (a) {
                                        function b(a) { a = a.data.$; if (y) { var c = l.$.createTextRange(); try { c.moveToPoint(a.clientX, a.clientY) } catch (d) { } y.setEndPoint(0 > v.compareEndPoints("StartToStart", c) ? "EndToEnd" : "StartToStart", c); y.select() } } function c() { p.removeListener("mousemove", b); h.removeListener("mouseup", c); p.removeListener("mouseup", c); y.select() } a = a.data; if (a.getTarget().is("html") && a.$.y < p.$.clientHeight &&
                                            a.$.x < p.$.clientWidth) { y = l.$.createTextRange(); try { y.moveToPoint(a.$.clientX, a.$.clientY) } catch (d) { } v = y.duplicate(); p.on("mousemove", b); h.on("mouseup", c); p.on("mouseup", c) }
                                    })
                                } if (7 < CKEDITOR.env.version && 11 > CKEDITOR.env.version) p.on("mousedown", function (a) { a.data.getTarget().is("html") && (h.on("mouseup", b), p.on("mouseup", b)) })
                            }
                            ...
                            }, null, null, -1); n.attachListener(n, "keydown", A(c), null, null, -1)
                ...
                }, null, null, 100); c.on("key", function (a) { if ("wysiwyg" == c.mode) { var b = c.getSelection(); if (b.isFake) { var d = x[a.data.keyCode]; if (d) return d({ editor: c, selected: b.getSelectedElement(), selection: b, keyEvent: a }) } } })
                ...
                }, null, null, -1); b.on("beforeSetMode", function () { w(b.editable()) }, null, null, -1); b.on("getSnapshot", function (a) { a.data && (a.data = y(a.data)) }, b, null, 20); b.on("toDataFormat", function (a) { a.data.dataValue = y(a.data.dataValue) }, null, null, 0)
                ...
                }; CKEDITOR.tools.extend(CKEDITOR.dom.selection, { _removeFillingCharSequenceString: y, _createFillingCharSequenceNode: g, FILLING_CHAR_SEQUENCE: v }); CKEDITOR.dom.selection.prototype = {
                    getNative: function () { return void 0 !== this._.cache.nativeSel ? this._.cache.nativeSel : this._.cache.nativeSel = m ? this.document.$.selection : this.document.getWindow().$.getSelection() }, getType: m ? function () {
                        ...
                        var a = this._.cache; if (a.type) return a.type; var b = CKEDITOR.SELECTION_TEXT, c = this.getNative(); if (!c || !c.rangeCount) b = CKEDITOR.SELECTION_NONE; else if (1 == c.rangeCount) {
                            var c = c.getRangeAt(0), d = c.startContainer; d == c.endContainer && 1 == d.nodeType && 1 == c.endOffset -
                                c.startOffset && K[d.childNodes[c.startOffset].nodeName.toLowerCase()] && (b = CKEDITOR.SELECTION_ELEMENT)
                        } return a.type = b
                    }, getRanges: function () {
                        var a = m ? function () {
                            function a(b) { return (new CKEDITOR.dom.node(b)).getIndex() } var b = function (b, c) {
                                b = b.duplicate(); b.collapse(c); var d = b.parentElement(); if (!d.hasChildNodes()) return { container: d, offset: 0 }; for (var e = d.children, g, f, h = b.duplicate(), k = 0, l = e.length - 1, p = -1, r, m; k <= l;)if (p = Math.floor((k + l) / 2), g = e[p], h.moveToElementText(g), r = h.compareEndPoints("StartToStart",
                                    b), 0 < r) l = p - 1; else if (0 > r) k = p + 1; else return { container: d, offset: a(g) }; if (-1 == p || p == e.length - 1 && 0 > r) { h.moveToElementText(d); h.setEndPoint("StartToStart", b); h = h.text.replace(/(\r\n|\r)/g, "\n").length; e = d.childNodes; if (!h) return g = e[e.length - 1], g.nodeType != CKEDITOR.NODE_TEXT ? { container: d, offset: e.length } : { container: g, offset: g.nodeValue.length }; for (d = e.length; 0 < h && 0 < d;)f = e[--d], f.nodeType == CKEDITOR.NODE_TEXT && (m = f, h -= f.nodeValue.length); return { container: m, offset: -h } } h.collapse(0 < r ? !0 : !1); h.setEndPoint(0 <
                                        r ? "StartToStart" : "EndToStart", b); h = h.text.replace(/(\r\n|\r)/g, "\n").length; if (!h) return { container: d, offset: a(g) + (0 < r ? 0 : 1) }; for (; 0 < h;)try { f = g[0 < r ? "previousSibling" : "nextSibling"], f.nodeType == CKEDITOR.NODE_TEXT && (h -= f.nodeValue.length, m = f), g = f } catch (w) { return { container: d, offset: a(g) } } return { container: m, offset: 0 < r ? -h : m.nodeValue.length + h }
                            }; return function () {
                        ...
                        }() : function () { var a = [], b, c = this.getNative(); if (!c) return a; for (var d = 0; d < c.rangeCount; d++) { var e = c.getRangeAt(d); b = new CKEDITOR.dom.range(this.root); b.setStart(new CKEDITOR.dom.node(e.startContainer), e.startOffset); b.setEnd(new CKEDITOR.dom.node(e.endContainer), e.endOffset); a.push(b) } return a }; return function (b) { var c = this._.cache, d = c.ranges; d || (c.ranges = d = new CKEDITOR.dom.rangeList(a.call(this))); return b ? t(new CKEDITOR.dom.rangeList(d.slice())) : d }
                        ...
                        var a = this._.cache; if (void 0 !== a.selectedElement) return a.selectedElement; var b = this, c = CKEDITOR.tools.tryThese(function () { return b.getNative().createRange().item(0) }, function () {
                            for (var a = b.getRanges()[0].clone(), c, d, e = 2; e && !((c = a.getEnclosedNode()) &&
                                c.type == CKEDITOR.NODE_ELEMENT && K[c.getName()] && (d = c)); e--)a.shrink(CKEDITOR.SHRINK_ELEMENT); return d && d.$
                        ...
                        if (c) for (var c = this.root, e, h = 0; h < a.length; ++h)e = a[h], e.endContainer.equals(c) && (e.endOffset = Math.min(e.endOffset, c.getChildCount())); if (a.length) if (this.isLocked) { var k = CKEDITOR.document.getActive(); this.unlock(); this.selectRanges(a); this.lock(); k && !k.equals(this.root) && k.focus() } else {
                            var q; a: {
                                var l, N; if (1 == a.length && !(N = a[0]).collapsed && (q = N.getEnclosedNode()) && q.type == CKEDITOR.NODE_ELEMENT && (N = N.clone(), N.shrink(CKEDITOR.SHRINK_ELEMENT, !0), (l = N.getEnclosedNode()) && l.type == CKEDITOR.NODE_ELEMENT &&
                                    (q = l), "false" == q.getAttribute("contenteditable"))) break a; q = void 0
                            } if (q) this.fake(q); else if (b && b.plugins.tableselection && b.plugins.tableselection.isSupportedEnvironment(b) && d(a) && !E && !a[0]._getTableElement({ table: 1 }).hasAttribute("data-cke-tableselection-ignored")) f.call(this, a); else {
                                if (m) {
                                    l = CKEDITOR.dom.walker.whitespaces(!0); q = /\ufeff|\u00a0/; N = { table: 1, tbody: 1, tr: 1 }; 1 < a.length && (b = a[a.length - 1], a[0].setEnd(b.endContainer, b.endOffset)); b = a[0]; a = b.collapsed; var n, C, L; if ((c = b.getEnclosedNode()) &&
                                        c.type == CKEDITOR.NODE_ELEMENT && c.getName() in K && (!c.is("a") || !c.getText())) try { L = c.$.createControlRange(); L.addElement(c.$); L.select(); return } catch (u) { } if (b.startContainer.type == CKEDITOR.NODE_ELEMENT && b.startContainer.getName() in N || b.endContainer.type == CKEDITOR.NODE_ELEMENT && b.endContainer.getName() in N) b.shrink(CKEDITOR.NODE_ELEMENT, !0), a = b.collapsed; L = b.createBookmark(); N = L.startNode; a || (k = L.endNode); L = b.document.$.body.createTextRange(); L.moveToElementText(N.$); L.moveStart("character", 1); k ? (q =
                                            b.document.$.body.createTextRange(), q.moveToElementText(k.$), L.setEndPoint("EndToEnd", q), L.moveEnd("character", -1)) : (n = N.getNext(l), C = N.hasAscendant("pre"), n = !(n && n.getText && n.getText().match(q)) && (C || !N.hasPrevious() || N.getPrevious().is && N.getPrevious().is("br")), C = b.document.createElement("span"), C.setHtml("\x26#65279;"), C.insertBefore(N), n && b.document.createText("﻿").insertBefore(N)); b.setStartBefore(N); N.remove(); a ? (n ? (L.moveStart("character", -1), L.select(), b.document.$.selection.clear()) : L.select(),
                                                b.moveToPosition(C, CKEDITOR.POSITION_BEFORE_START), C.remove()) : (b.setEndBefore(k), k.remove(), L.select())
                                } else {
                                    k = this.getNative(); if (!k) return; this.removeAllRanges(); for (L = 0; L < a.length; L++) {
                                        if (L < a.length - 1 && (n = a[L], C = a[L + 1], q = n.clone(), q.setStart(n.endContainer, n.endOffset), q.setEnd(C.startContainer, C.startOffset), !q.collapsed && (q.shrink(CKEDITOR.NODE_ELEMENT, !0), b = q.getCommonAncestor(), q = q.getEnclosedNode(), b.isReadOnly() || q && q.isReadOnly()))) {
                                            C.setStart(n.startContainer, n.startOffset); a.splice(L--,
                                                1); continue
                                        } b = a[L]; C = this.document.$.createRange(); b.collapsed && CKEDITOR.env.webkit && r(b) && (q = g(this.root), b.insertNode(q), (n = q.getNext()) && !q.getPrevious() && n.type == CKEDITOR.NODE_ELEMENT && "br" == n.getName() ? (w(this.root), b.moveToPosition(n, CKEDITOR.POSITION_BEFORE_START)) : b.moveToPosition(q, CKEDITOR.POSITION_AFTER_END)); C.setStart(b.startContainer.$, b.startOffset); try { C.setEnd(b.endContainer.$, b.endOffset) } catch (t) {
                                            if (0 <= t.toString().indexOf("NS_ERROR_ILLEGAL_VALUE")) b.collapse(1), C.setEnd(b.endContainer.$,
                                                b.endOffset); else throw t;
                                        } k.addRange(C)
                                    }
    ...
    (function () {
        function a(a, b) { for (var c, d; (a = a.getParent()) && !a.equals(b);)if (a.getAttribute("data-nostyle")) c = a; else if (!d) { var e = a.getAttribute("contentEditable"); "false" == e ? c = a : "true" == e && (d = 1) } return c } function d(a, b, c, d) { return (a.getPosition(b) | d) == d && (!c.childRule || c.childRule(a)) } function b(c) {
            var e = c.document; if (c.collapsed) e = M(this, e), c.insertNode(e), c.moveToPosition(e, CKEDITOR.POSITION_BEFORE_END); else {
                var g = this.element, h = this._.definition, k, l = h.ignoreReadonly, r = l || h.includeReadonly; null ==
                    r && (r = c.root.getCustomData("cke_includeReadonly")); var m = CKEDITOR.dtd[g]; m || (k = !0, m = CKEDITOR.dtd.span); c.enlarge(CKEDITOR.ENLARGE_INLINE, 1); c.trim(); var p = c.createBookmark(), w = p.startNode, u = p.endNode, t = w, y; if (!l) { var v = c.getCommonAncestor(), l = a(w, v), v = a(u, v); l && (t = l.getNextSourceNode(!0)); v && (u = v) } for (t.getPosition(u) == CKEDITOR.POSITION_FOLLOWING && (t = 0); t;) {
                        l = !1; if (t.equals(u)) t = null, l = !0; else {
                            var z = t.type == CKEDITOR.NODE_ELEMENT ? t.getName() : null, v = z && "false" == t.getAttribute("contentEditable"), x = z &&
                                -1 !== CKEDITOR.tools.array.indexOf(CKEDITOR.style.unstylableElements, z), x = z && (t.getAttribute("data-nostyle") || x); if (z && t.data("cke-bookmark") || t.type === CKEDITOR.NODE_COMMENT) { t = t.getNextSourceNode(!0); continue } if (v && r && CKEDITOR.dtd.$block[z]) for (var D = t, E = f(D), F = void 0, G = E.length, H = 0, D = G && new CKEDITOR.dom.range(D.getDocument()); H < G; ++H) { var F = E[H], J = CKEDITOR.filter.instances[F.data("cke-filter")]; if (J ? J.check(this) : 1) D.selectNodeContents(F), b.call(this, D) } E = z ? !m[z] || x ? 0 : v && !r ? 0 : d(t, u, h, T) : 1; if (E) if (F =
                                    t.getParent(), E = h, G = g, H = k, !F || !(F.getDtd() || CKEDITOR.dtd.span)[G] && !H || E.parentRule && !E.parentRule(F)) l = !0; else { if (y || z && CKEDITOR.dtd.$removeEmpty[z] && (t.getPosition(u) | T) != T || (y = c.clone(), y.setStartBefore(t)), z = t.type, z == CKEDITOR.NODE_TEXT || v || z == CKEDITOR.NODE_ELEMENT && !t.getChildCount()) { for (var z = t, K; (l = !z.getNext(B)) && (K = z.getParent(), m[K.getName()]) && d(K, w, h, O);)z = K; y.setEndAfter(z) } } else l = !0; t = t.getNextSourceNode(x || v)
                        } if (l && y && !y.collapsed) {
                            for (var l = M(this, e), v = l.hasAttributes(), x = y.getCommonAncestor(),
                                z = {}, E = {}, F = {}, G = {}, U, R, Y; l && x;) { if (x.getName() == g) { for (U in h.attributes) !G[U] && (Y = x.getAttribute(R)) && (l.getAttribute(U) == Y ? E[U] = 1 : G[U] = 1); for (R in h.styles) !F[R] && (Y = x.getStyle(R)) && (l.getStyle(R) == Y ? z[R] = 1 : F[R] = 1) } x = x.getParent() } for (U in E) l.removeAttribute(U); for (R in z) l.removeStyle(R); v && !l.hasAttributes() && (l = null); l ? (y.extractContents().appendTo(l), y.insertNode(l), A.call(this, l), l.mergeSiblings(), CKEDITOR.env.ie || l.$.normalize()) : (l = new CKEDITOR.dom.element("span"), y.extractContents().appendTo(l),
                                    y.insertNode(l), A.call(this, l), l.remove(!0)); y = null
                        }
                    } c.moveToBookmark(p); c.shrink(CKEDITOR.SHRINK_TEXT); c.shrink(CKEDITOR.NODE_ELEMENT, !0)
            }
        } function c(a) {
            function b() {
                for (var a = new CKEDITOR.dom.elementPath(d.getParent()), c = new CKEDITOR.dom.elementPath(r.getParent()), e = null, g = null, f = 0; f < a.elements.length; f++) { var h = a.elements[f]; if (h == a.block || h == a.blockLimit) break; m.checkElementRemovable(h, !0) && (e = h) } for (f = 0; f < c.elements.length; f++) {
                    h = c.elements[f]; if (h == c.block || h == c.blockLimit) break; m.checkElementRemovable(h,
                        !0) && (g = h)
                } g && r.breakParent(g); e && d.breakParent(e)
                ...
                for (var g = new CKEDITOR.dom.elementPath(d.getParent(), a.root), f, h = 0, k; h < g.elements.length && (k = g.elements[h]) && k != g.block && k != g.blockLimit; h++)if (this.checkElementRemovable(k)) {
                    var l; !e && a.collapsed && (a.checkBoundaryOfElement(k, CKEDITOR.END) || (l = a.checkBoundaryOfElement(k, CKEDITOR.START))) ? (f = k, f.match = l ? "start" : "end") :
                        (k.mergeSiblings(), k.is(this.element) ? z.call(this, k) : t(k, E(this)[k.getName()]))
                ...
                var r = c.endNode, m = this; b(); for (g = d; !g.equals(r);)f = g.getNextSourceNode(), g.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(g) && (g.getName() == this.element ? z.call(this, g) : t(g, E(this)[g.getName()]), f.type == CKEDITOR.NODE_ELEMENT && f.contains(d) &&
                    (b(), f = d.getNext())), g = f
            } a.moveToBookmark(c); a.shrink(CKEDITOR.NODE_ELEMENT, !0)
        } function f(a) { var b = []; a.forEach(function (a) { if ("true" == a.getAttribute("contenteditable")) return b.push(a), !1 }, CKEDITOR.NODE_ELEMENT, !0); return b } function e(a) { var b = a.getEnclosedNode() || a.getCommonAncestor(!1, !0); (a = (new CKEDITOR.dom.elementPath(b, a.root)).contains(this.element, 1)) && !a.isReadOnly() && v(a, this) } function k(a) {
        ...
        } function h(a) { var b = a.createBookmark(!0), c = a.createIterator(); c.enforceRealBlocks = !0; this._.enterMode && (c.enlargeBr = this._.enterMode != CKEDITOR.ENTER_BR); for (var d, e = a.document, g; d = c.getNextParagraph();)!d.isReadOnly() && (c.activeFilter ? c.activeFilter.check(this) : 1) && (g = M(this, e, d), r(d, g)); a.moveToBookmark(b) } function l(a) {
            var b = a.createBookmark(1),
            c = a.createIterator(); c.enforceRealBlocks = !0; c.enlargeBr = this._.enterMode != CKEDITOR.ENTER_BR; for (var d, e; d = c.getNextParagraph();)this.checkElementRemovable(d) && (d.is("pre") ? ((e = this._.enterMode == CKEDITOR.ENTER_BR ? null : a.document.createElement(this._.enterMode == CKEDITOR.ENTER_P ? "p" : "div")) && d.copyAttributes(e), r(d, e)) : z.call(this, d)); a.moveToBookmark(b)
        } function r(a, b) {
            ...
            var c = this._.definition, d = c.attributes, c = c.styles, e = E(this)[a.getName()], g = CKEDITOR.tools.isEmpty(d) && CKEDITOR.tools.isEmpty(c), f; for (f in d) if ("class" != f && !this._.definition.fullMatch || a.getAttribute(f) == u(f, d[f])) b && "data-" == f.slice(0, 5) || (g = a.hasAttribute(f), a.removeAttribute(f)); for (var h in c) this._.definition.fullMatch && a.getStyle(h) != u(h, c[h], !0) || (g = g || !!a.getStyle(h), a.removeStyle(h));
            t(a, e, x[a.getName()]); g && (this._.definition.alwaysRemoveElement ? m(a, 1) : !CKEDITOR.dtd.$block[a.getName()] || this._.enterMode == CKEDITOR.ENTER_BR && !a.hasAttributes() ? m(a) : a.renameNode(this._.enterMode == CKEDITOR.ENTER_P ? "p" : "div"))
        } function A(a) { for (var b = E(this), c = a.getElementsByTag(this.element), d, e = c.count(); 0 <= --e;)d = c.getItem(e), d.isReadOnly() || z.call(this, d, !0); for (var g in b) if (g != this.element) for (c = a.getElementsByTag(g), e = c.count() - 1; 0 <= e; e--)d = c.getItem(e), d.isReadOnly() || t(d, b[g]) } function t(a,
            b, c) { if (b = b && b.attributes) for (var d = 0; d < b.length; d++) { var e = b[d][0], g; if (g = a.getAttribute(e)) { var f = b[d][1]; (null === f || f.test && f.test(g) || "string" == typeof f && g == f) && a.removeAttribute(e) } } c || m(a) } function m(a, b) {
                if (!a.hasAttributes() || b) if (CKEDITOR.dtd.$block[a.getName()]) { var c = a.getPrevious(G), d = a.getNext(G); !c || c.type != CKEDITOR.NODE_TEXT && c.isBlockBoundary({ br: 1 }) || a.append("br", 1); !d || d.type != CKEDITOR.NODE_TEXT && d.isBlockBoundary({ br: 1 }) || a.append("br"); a.remove(!0) } else c = a.getFirst(), d = a.getLast(),
                    a.remove(!0), c && (c.type == CKEDITOR.NODE_ELEMENT && c.mergeSiblings(), d && !c.equals(d) && d.type == CKEDITOR.NODE_ELEMENT && d.mergeSiblings())
            } function M(a, b, c) { var d; d = a.element; "*" == d && (d = "span"); d = new CKEDITOR.dom.element(d, b); c && c.copyAttributes(d); d = v(d, a); b.getCustomData("doc_processing_style") && d.hasAttribute("id") ? d.removeAttribute("id") : b.setCustomData("doc_processing_style", 1); return d } function v(a, b) {
            ...
            } function J(a, b) { for (var c in a) a[c] = a[c].replace(D, function (a, c) { return b[c] }) } function E(a) {
            ...
            } function u(a, b, c) { var d = new CKEDITOR.dom.element("span"); d[c ? "setStyle" : "setAttribute"](a, b); return d[c ? "getStyle" : "getAttribute"](a) } function F(a, b) {
                ...
                return !0
            } function H(a, b, c) { var d = a.getRanges(); b = b ? this.removeFromRange : this.applyToRange; for (var e, g = d.createIterator(); e = g.getNextRange();)b.call(this, e, c); a.selectRanges(d) } var x = { address: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, p: 1, pre: 1, section: 1, header: 1, footer: 1, nav: 1, article: 1, aside: 1, figure: 1, dialog: 1, hgroup: 1, time: 1, meter: 1, menu: 1, command: 1, keygen: 1, output: 1, progress: 1, details: 1, datagrid: 1, datalist: 1 }, K = {
                a: 1, blockquote: 1, embed: 1, hr: 1, img: 1, li: 1, object: 1, ol: 1, table: 1, td: 1, tr: 1, th: 1, ul: 1, dl: 1,
                dt: 1, dd: 1, form: 1, audio: 1, video: 1
            }, p = /\s*(?:;\s*|$)/, D = /#\((.+?)\)/g, B = CKEDITOR.dom.walker.bookmark(0, 1), G = CKEDITOR.dom.walker.whitespaces(1); CKEDITOR.style = function (a, b) {
                if ("string" == typeof a.type) return new CKEDITOR.style.customHandlers[a.type](a); var c = a.attributes; c && c.style && (a.styles = CKEDITOR.tools.extend({}, a.styles, CKEDITOR.tools.parseCssText(c.style)), delete c.style); b && (a = CKEDITOR.tools.clone(a), J(a.attributes, b), J(a.styles, b)); c = this.element = a.element ? "string" == typeof a.element ? a.element.toLowerCase() :
                    a.element : "*"; this.type = a.type || (x[c] ? CKEDITOR.STYLE_BLOCK : K[c] ? CKEDITOR.STYLE_OBJECT : CKEDITOR.STYLE_INLINE); "object" == typeof this.element && (this.type = CKEDITOR.STYLE_OBJECT); this._ = { definition: a }
        ...
        CKEDITOR.style.getStyleText = function (a) { var b = a._ST; if (b) return b; var b = a.styles, c = a.attributes && a.attributes.style || "", d = ""; c.length && (c = c.replace(p, ";")); for (var e in b) { var g = b[e], f = (e + ":" + g).replace(p, ";"); "inherit" == g ? d += f : c += f } c.length && (c = CKEDITOR.tools.normalizeCssText(c, !0)); return a._ST = c + d }; CKEDITOR.style.customHandlers = {}; CKEDITOR.style.unstylableElements = []; CKEDITOR.style.addCustomHandler = function (a) {
        ...
        }; var T = CKEDITOR.POSITION_PRECEDING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED, O = CKEDITOR.POSITION_FOLLOWING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED
    ...
    (function () {
        var a = {}, d = {}, b; for (b in CKEDITOR.dtd.$blockLimit) b in CKEDITOR.dtd.$list || (a[b] = 1); for (b in CKEDITOR.dtd.$block) b in CKEDITOR.dtd.$blockLimit || b in CKEDITOR.dtd.$empty || (d[b] = 1); CKEDITOR.dom.elementPath = function (b, f) {
            var e = null, k = null, h = [], l = b, r; f = f || b.getDocument().getBody(); l || (l = f); do if (l.type == CKEDITOR.NODE_ELEMENT) {
                h.push(l); if (!this.lastElement && (this.lastElement = l, l.is(CKEDITOR.dtd.$object) || "false" == l.getAttribute("contenteditable"))) continue; if (l.equals(f)) break; if (!k && (r = l.getName(),
                    "true" == l.getAttribute("contenteditable") ? k = l : !e && d[r] && (e = l), a[r])) { if (r = !e && "div" == r) { a: { r = l.getChildren(); for (var g = 0, w = r.count(); g < w; g++) { var y = r.getItem(g); if (y.type == CKEDITOR.NODE_ELEMENT && CKEDITOR.dtd.$block[y.getName()]) { r = !0; break a } } r = !1 } r = !r } r ? e = l : k = l }
                ...
                var a = this, c = CKEDITOR.dom.walker.bookmark(), d = [], e; return {
                    getNextRange: function (k) {
                        e = void 0 === e ? 0 : e + 1; var h = a[e]; if (h && 1 < a.length) {
                            if (!e) for (var l = a.length - 1; 0 <= l; l--)d.unshift(a[l].createBookmark(!0)); if (k) for (var r = 0; a[e + r + 1];) {
                                var g = h.document; k = 0; l = g.getById(d[r].endNode); for (g = g.getById(d[r + 1].startNode); ;) {
                                    l =
                                    l.getNextSourceNode(!1); if (g.equals(l)) k = 1; else if (c(l) || l.type == CKEDITOR.NODE_ELEMENT && l.isBlockBoundary()) continue; break
                                } if (!k) break; r++
                            } for (h.moveToBookmark(d.shift()); r--;)l = a[++e], l.moveToBookmark(d.shift()), h.setEnd(l.endContainer, l.endOffset)
                        } return h
                    }
                }
...
*/
    ...
    (function () {
        function I(a) { a._.tabBarMode = !0; a._.tabs[a._.currentTabId][0].focus(); a._.currentFocusIndex = -1 } function J() { for (var a = this._.tabIdList.length, b = CKEDITOR.tools.indexOf(this._.tabIdList, this._.currentTabId) + a, c = b - 1; c > b - a; c--)if (this._.tabs[this._.tabIdList[c % a]][0].$.offsetHeight) return this._.tabIdList[c % a]; return null } function W() {
            ...
            function b(b) {
                var c = a.getSize(), h = a.parts.dialog.getParent().getClientSize(), q = b.data.$.screenX, n = b.data.$.screenY,
                r = q - e.x, m = n - e.y; e = { x: q, y: n }; d.x += r; d.y += m; q = d.x + k[3] < g ? -k[3] : d.x - k[1] > h.width - c.width - g ? h.width - c.width + ("rtl" == f.lang.dir ? 0 : k[1]) : d.x; c = d.y + k[0] < g ? -k[0] : d.y - k[2] > h.height - c.height - g ? h.height - c.height + k[2] : d.y; q = Math.floor(q); c = Math.floor(c); a.move(q, c, 1); b.data.preventDefault()
            } function c() {
            ...
            function b(b) {
                var c = "rtl" == f.lang.dir, n = h.width, q = h.height, w = n + (b.data.$.screenX - l.x) * (c ? -1 : 1) * (a._.moved ? 1 : 2), A = q + (b.data.$.screenY - l.y) * (a._.moved ? 1 : 2), C = a._.element.getFirst(), C = c && parseInt(C.getComputedStyle("right"), 10), v = a.getPosition(); v.x = v.x || 0; v.y = v.y || 0; v.y + A > p.height && (A = p.height - v.y); (c ? C : v.x) + w > p.width && (w = p.width - (c ? C : v.x)); A = Math.floor(A); w = Math.floor(w); if (d == CKEDITOR.DIALOG_RESIZE_WIDTH || d == CKEDITOR.DIALOG_RESIZE_BOTH) n =
                    Math.max(e.minWidth || 0, w - g); if (d == CKEDITOR.DIALOG_RESIZE_HEIGHT || d == CKEDITOR.DIALOG_RESIZE_BOTH) q = Math.max(e.minHeight || 0, A - k); a.resize(n, q); a._.moved && O(a, a._.position.x, a._.position.y); a._.moved || a.layout(); b.data.preventDefault()
                ...
                d = e.resizable; if (d != CKEDITOR.DIALOG_RESIZE_NONE) {
                    var f = a.getParentEditor(), g, k, p, l, h, q, n = CKEDITOR.tools.addFunction(function (d) {
                        function e(a) { return a.isVisible() } h = a.getSize(); var f = a.parts.contents, n = f.$.getElementsByTagName("iframe").length, w = !(CKEDITOR.env.gecko || CKEDITOR.env.ie && CKEDITOR.env.quirks); n && (q = CKEDITOR.dom.element.createFromHtml('\x3cdiv class\x3d"cke_dialog_resize_cover" style\x3d"height: 100%; position: absolute; width: 100%; left:0; top:0;"\x3e\x3c/div\x3e'), f.append(q)); k = h.height -
                        ...
                        var b = ""; d == CKEDITOR.DIALOG_RESIZE_WIDTH ? b = " cke_resizer_horizontal" : d == CKEDITOR.DIALOG_RESIZE_HEIGHT &&
                            (b = " cke_resizer_vertical"); b = CKEDITOR.dom.element.createFromHtml('\x3cdiv class\x3d"cke_resizer' + b + " cke_resizer_" + f.lang.dir + '" title\x3d"' + CKEDITOR.tools.htmlEncode(f.lang.common.resize) + '" onmousedown\x3d"CKEDITOR.tools.callFunction(' + n + ', event )"\x3e' + ("ltr" == f.lang.dir ? "◢" : "◣") + "\x3c/div\x3e"); a.parts.footer.append(b, 1)
        ...
        CKEDITOR.dialog = function (a, b) {
            function c() { var a = m._.focusList; a.sort(function (a, b) { return a.tabIndex != b.tabIndex ? b.tabIndex - a.tabIndex : a.focusIndex - b.focusIndex }); for (var b = a.length, c = 0; c < b; c++)a[c].focusIndex = c } function e(a) {
                var b = m._.focusList; a = a || 0; if (!(1 > b.length)) {
                    var c = m._.currentFocusIndex; m._.tabBarMode && 0 > a && (c = 0); try { b[c].getInputElement().$.blur() } catch (d) { } var e = c, f = 1 < m._.pageCount; do {
                        e += a; if (f && !m._.tabBarMode && (e == b.length || -1 == e)) {
                ...
                if (m == CKEDITOR.dialog._.currentTop) {
                    var c = b.data.getKeystroke(), d = "rtl" == a.lang.dir, g = [37, 38, 39, 40]; q = n = 0; if (9 == c || c == CKEDITOR.SHIFT + 9) e(c == CKEDITOR.SHIFT + 9 ? -1 : 1), q = 1; else if (c == CKEDITOR.ALT + 121 && !m._.tabBarMode && 1 < m.getPageCount()) I(m), q = 1; else if (-1 != CKEDITOR.tools.indexOf(g, c) && m._.tabBarMode) c = -1 != CKEDITOR.tools.indexOf([d ? 39 : 37, 38], c) ?
                        J.call(m) : W.call(m), m.selectPage(c), m._.tabs[c][0].focus(), q = 1; else if (13 != c && 32 != c || !m._.tabBarMode) if (13 == c) c = b.data.getTarget(), c.is("a", "button", "select", "textarea") || c.is("input") && "button" == c.$.type || ((c = this.getButton("ok")) && CKEDITOR.tools.setTimeout(c.click, 0, c), q = 1), n = 1; else if (27 == c) (c = this.getButton("cancel")) ? CKEDITOR.tools.setTimeout(c.click, 0, c) : !1 !== this.fire("cancel", { hide: !0 }).hide && this.hide(), n = 1; else return; else this.selectPage(this._.currentTabId), this._.tabBarMode = !1, this._.currentFocusIndex =
                            -1, e(1), q = 1; f(b)
                }
            } function f(a) { q ? a.data.preventDefault(1) : n && a.data.stopPropagation() } var g = CKEDITOR.dialog._.dialogDefinitions[b], k = CKEDITOR.tools.clone(U), p = a.config.dialog_buttonsOrder || "OS", l = a.lang.dir, h = {}, q, n; ("OS" == p && CKEDITOR.env.mac || "rtl" == p && "ltr" == l || "ltr" == p && "rtl" == l) && k.buttons.reverse(); g = CKEDITOR.tools.extend(g(a), k); g = CKEDITOR.tools.clone(g); g = new M(this, g); k = Z(a); this._ = {
                ...
                { name: b, definition: g, dialog: this }, a).definition; if (!("removeDialogTabs" in a._) && a.config.removeDialogTabs) { k = a.config.removeDialogTabs.split(";"); for (l = 0; l < k.length; l++)if (p = k[l].split(":"), 2 == p.length) { var r = p[0]; h[r] || (h[r] = []); h[r].push(p[1]) } a._.removeDialogTabs = h } if (a._.removeDialogTabs && (h = a._.removeDialogTabs[b])) for (l = 0; l < h.length; l++)g.removeContents(h[l]); if (g.onLoad) this.on("load", g.onLoad); if (g.onShow) this.on("show", g.onShow); if (g.onHide) this.on("hide", g.onHide); if (g.onOk) this.on("ok",
                    function (b) { a.fire("saveSnapshot"); setTimeout(function () { a.fire("saveSnapshot") }, 0); !1 === g.onOk.call(this, b) && (b.data.hide = !1) }); this.state = CKEDITOR.DIALOG_STATE_IDLE; if (g.onCancel) this.on("cancel", function (a) { !1 === g.onCancel.call(this, a) && (a.data.hide = !1) }); var m = this, t = function (a) { var b = m._.contents, c = !1, d; for (d in b) for (var e in b[d]) if (c = a.call(this, b[d][e])) return }; this.on("ok", function (a) {
                        ...
                        c(); var b = 1 < m._.pageCount; a.config.dialog_startupFocusTab && b ? (m._.tabBarMode = !0, m._.tabs[m._.currentTabId][0].focus(), m._.currentFocusIndex = -1) : this._.hasFocus || (this._.currentFocusIndex = b ? -1 : this._.focusList.length -
            ...
            G = function (a, b, c) { for (var e = 0, d; d = a[e]; e++) { if (d.id == b) return a.splice(e, 1); if (c && d[c] && (d = G(d[c], b, c))) return d } return null }; M.prototype = { getContents: function (a) { return E(this.contents, a) }, getButton: function (a) { return E(this.buttons, a) }, addContents: function (a, b) { return F(this.contents, a, b) }, addButton: function (a, b) { return F(this.buttons, a, b) }, removeContents: function (a) { G(this.contents, a) }, removeButton: function (a) { G(this.buttons, a) } }; N.prototype = {
                ...
                CKEDITOR.ui.dialog = {
                    uiElement: function (a, b, c, e, d, f, g) {
                        if (!(4 > arguments.length)) {
                            var k = (e.call ? e(b) : e) || "div", p = ["\x3c", k, " "], l = (d && d.call ? d(b) : d) || {}, h = (f && f.call ? f(b) : f) || {}, q = (g && g.call ? g.call(this, a, b) : g) || "", n = this.domId = h.id || CKEDITOR.tools.getNextId() + "_uiElement"; b.requiredContent && !a.getParentEditor().filter.check(b.requiredContent) && (l.display = "none", this.notAllowed =
                                !0); h.id = n; var r = {}; b.type && (r["cke_dialog_ui_" + b.type] = 1); b.className && (r[b.className] = 1); b.disabled && (r.cke_disabled = 1); for (var m = h["class"] && h["class"].split ? h["class"].split(" ") : [], n = 0; n < m.length; n++)m[n] && (r[m[n]] = 1); m = []; for (n in r) m.push(n); h["class"] = m.join(" "); b.title && (h.title = b.title); r = (b.style || "").split(";"); b.align && (m = b.align, l["margin-left"] = "left" == m ? 0 : "auto", l["margin-right"] = "right" == m ? 0 : "auto"); for (n in l) r.push(n + ":" + l[n]); b.hidden && r.push("display:none"); for (n = r.length - 1; 0 <=
                                    n; n--)"" === r[n] && r.splice(n, 1); 0 < r.length && (h.style = (h.style ? h.style + "; " : "") + r.join("; ")); for (n in h) p.push(n + '\x3d"' + CKEDITOR.tools.htmlEncode(h[n]) + '" '); p.push("\x3e", q, "\x3c/", k, "\x3e"); c.push(p.join("")); (this._ || (this._ = {})).dialog = a; "boolean" == typeof b.isChanged && (this.isChanged = function () { return b.isChanged }); "function" == typeof b.isChanged && (this.isChanged = b.isChanged); "function" == typeof b.setValue && (this.setValue = CKEDITOR.tools.override(this.setValue, function (a) {
                                        return function (c) {
                                            a.call(this,
                ...
                var a = /^\d*$/, b = /^\d*(?:\.\d+)?$/, c = /^(((\d*(\.\d+))|(\d*))(px|\%)?)?$/, e = /^(((\d*(\.\d+))|(\d*))(px|em|ex|in|cm|mm|pt|pc|\%)?)?$/i, d = /^(--|-?([a-zA-Z_]|\\))(\\|[a-zA-Z0-9-_])*\s*?:\s*?[^:;]+$/; CKEDITOR.VALIDATE_OR = 1; CKEDITOR.VALIDATE_AND = 2; CKEDITOR.dialog.validate = {
                    functions: function () {
                        var a = arguments; return function () {
                            var b = this && this.getValue ? this.getValue() : a[0], c, d = CKEDITOR.VALIDATE_AND, e = [], h; for (h = 0; h < a.length; h++)if ("function" == typeof a[h]) e.push(a[h]);
                            else break; h < a.length && "string" == typeof a[h] && (c = a[h], h++); h < a.length && "number" == typeof a[h] && (d = a[h]); var q = d == CKEDITOR.VALIDATE_AND ? !0 : !1; for (h = 0; h < e.length; h++)q = d == CKEDITOR.VALIDATE_AND ? q && e[h](b) : q || e[h](b); return q ? !0 : c
                        }
                    }, regex: function (a, b) { return function (c) { c = this && this.getValue ? this.getValue() : c; return a.test(c) ? !0 : b } }, notEmpty: function (a) {
                        var b = RegExp("^[\\u0020\\u00a0\\u1680\\u202f\\u205f\\u3000\\u2000-\\u200a\\s]+|[\\u0020\\u00a0\\u1680\\u202f\\u205f\\u3000\\u2000-\\u200a\\s]+$", "g");
                        return function (c) { return 0 < (this && this.getValue ? this.getValue() : c).replace(b, "").length || a }
                        ...
                        return this.functions(function (a) {
                            a = CKEDITOR.tools.trim(a).split(";"); "" === a[a.length - 1] && a.pop();
                            return CKEDITOR.tools.array.every(a, function (a) { return d.test(CKEDITOR.tools.trim(a)) })
                        }, a)
                    ...
                    openDialog: function (a, b, c) {
                        var e = null, d = CKEDITOR.dialog._.dialogDefinitions[a]; null === CKEDITOR.dialog._.currentTop && P(this); if ("function" == typeof d) d = this._.storedDialogs || (this._.storedDialogs = {}), e = d[a] || (d[a] = new CKEDITOR.dialog(this, a)), e.setModel(c), b && b.call(e, e), e.show(); else {
                            if ("failed" == d) throw Q(this), Error('[CKEDITOR.dialog.openDialog] Dialog "' + a + '" failed when loading definition.'); "string" == typeof d && CKEDITOR.scriptLoader.load(CKEDITOR.getUrl(d), function () {
                                ...
                                (CKEDITOR.dialog._.dialogDefinitions[a] = "failed"); this.openDialog(a, b, c)
                            }, this, 0, 1)
    ...
    CKEDITOR.htmlWriter = CKEDITOR.tools.createClass({
        ...
        function v(a) {
            function d(a) { var b = !1; h.attachListener(h, "keydown", function () { var f = c.getBody().getElementsByTag(a); if (!b) { for (var d = 0; d < f.count(); d++)f.getItem(d).setCustomData("retain", !0); b = !0 } }, null, null, 1); h.attachListener(h, "keyup", function () { var d = c.getElementsByTag(a); b && (1 == d.count() && !d.getItem(0).getCustomData("retain") && CKEDITOR.tools.isEmpty(d.getItem(0).getAttributes()) && d.getItem(0).remove(1), b = !1) }) } var b = this.editor; if (b && !b.isDetached()) {
                ...
                f && f.parentNode.removeChild(f); (f = c.getElementById("cke_shimscrpt")) && f.parentNode.removeChild(f); (f = c.getElementById("cke_basetagscrpt")) && f.parentNode.removeChild(f); e.contentEditable = !0; CKEDITOR.env.ie && (e.hideFocus = !0, e.disabled = !0, e.removeAttribute("disabled")); delete this._.isLoadingData; this.$ = e; c = new CKEDITOR.dom.document(c); this.setup(); this.fixInitialSelection(); var h = this; CKEDITOR.env.ie && !CKEDITOR.env.edge && c.getDocumentElement().addClass(c.$.compatMode); CKEDITOR.env.ie && !CKEDITOR.env.edge &&
                    ...
                    }); CKEDITOR.env.ie && this.attachListener(c, "blur", function () { try { c.$.selection.empty() } catch (a) { } }); CKEDITOR.env.iOS && this.attachListener(c, "touchend", function () { a.focus() }); e = b.document.getElementsByTag("title").getItem(0);
                e.data("cke-title", e.getText()); CKEDITOR.env.ie && (b.document.$.title = this._.docTitle); CKEDITOR.tools.setTimeout(function () { "unloaded" == this.status && (this.status = "ready"); b.fire("contentDom"); this._.isPendingFocus && (b.focus(), this._.isPendingFocus = !1); setTimeout(function () { b.fire("dataReady") }, 0) }, 0, this)
            }
        } function w(a) {
            function d() {
            ...
            } function b(a) { a.returnValue = !1 } if (CKEDITOR.env.gecko) try { var c = a.document.$; c.execCommand("enableObjectResizing", !1, !a.config.disableObjectResizing); c.execCommand("enableInlineTableEditing", !1, !a.config.disableNativeTableHandles) } catch (e) { } else CKEDITOR.env.ie && 11 > CKEDITOR.env.version && a.config.disableObjectResizing && d()
        } function x() {
            ...
            init: function (a) {
                a.config.fullPage && a.addFeature({
                    ...
                    function b(b) { b && b.removeListener(); if (!a.isDestroyed() && !a.isDetached() && (a.editable(new l(a, g.getFrameDocument().getBody())), a.setData(a.getData(1), d), t)) { if (u) a.on("mode", c, { iframe: g, editor: a, callback: d }); a.on("mode", function () { a.status = "ready" }); e() } } function c(a) { a && a.removeListener(); g.on("load", function () { p && (p = !1, f()) }) } function e() {
                        m = new MutationObserver(function (b) {
                            for (var c = 0; c < b.length; c++) {
                                var d = b[c]; if ("childList" === d.type && 0 !==
                                    d.addedNodes.length) for (var e = 0; e < d.addedNodes.length; e++) { var g = d.addedNodes[e]; g.contains && g.contains(a.container.$) && (u ? p = !0 : f()) }
                            }
                        }); m.observe(a.config.observableParent, { childList: !0, subtree: !0 })
                    } function f() { var b = a.getData(!1), c; a.editable().preserveIframe = !0; a.editable(null); c = new l(a, g.getFrameDocument().getBody()); a.editable(c); a.status = "recreating"; a.setData(b, { callback: d, internal: !1, noSnapshot: !1 }) } var h = "document.open();" + (CKEDITOR.env.ie ? "(" + CKEDITOR.tools.fixDomain + ")();" : "") + "document.close();",
        ...
        }); CKEDITOR.editor.prototype.addContentsCss = function (a) { var d = this.config, b = d.contentsCss; CKEDITOR.tools.isArray(b) || (d.contentsCss = b ? [b] : []); d.contentsCss.push(a) }; l = CKEDITOR.tools.createClass({
            $: function () { this.base.apply(this, arguments); this._.frameLoadedHandler = CKEDITOR.tools.addFunction(function (a) { CKEDITOR.tools.setTimeout(v, 0, this, a) }, this); this._.docTitle = this.getWindow().getFrame().getAttribute("title") }, base: CKEDITOR.editable, proto: {
                preserveIframe: !1,
                setData: function (a, d) {
                    var b = this.editor; if (d) this.setHtml(a), this.fixInitialSelection(), b.fire("dataReady"); else {
                        this._.isLoadingData = !0; b._.dataStore = { id: 1 }; var c = b.config, e = c.fullPage, f = c.docType, h = CKEDITOR.tools.buildStyleHtml(x()).replace(/<style>/, '\x3cstyle data-cke-temp\x3d"1"\x3e'); e || (h += CKEDITOR.tools.buildStyleHtml(b.config.contentsCss)); var g = c.baseHref ? '\x3cbase href\x3d"' + c.baseHref + '" data-cke-temp\x3d"1" /\x3e' : ""; e && (a = a.replace(/<!DOCTYPE[^>]*>/i, function (a) { b.docType = f = a; return "" }).replace(/<\?xml\s[^\?]*\?>/i,
                    ...
                    if (!this.preserveIframe) {
                        var a = this.editor, d = a.document, a = a.container.findOne("iframe.cke_wysiwyg_frame"); l.baseProto.detach.call(this);
                ...
                if (!a.blockless) {
                    var c = new h(a, "justifyleft", "left"), b = new h(a, "justifycenter", "center"), f = new h(a,
                        "justifyright", "right"), d = new h(a, "justifyblock", "justify"); a.addCommand("justifyleft", c); a.addCommand("justifycenter", b); a.addCommand("justifyright", f); a.addCommand("justifyblock", d); a.ui.addButton && (a.ui.addButton("JustifyLeft", { label: a.lang.common.alignLeft, command: "justifyleft", toolbar: "align,10" }), a.ui.addButton("JustifyCenter", { label: a.lang.common.center, command: "justifycenter", toolbar: "align,20" }), a.ui.addButton("JustifyRight", { label: a.lang.common.alignRight, command: "justifyright", toolbar: "align,30" }),
                            a.ui.addButton("JustifyBlock", { label: a.lang.common.justify, command: "justifyblock", toolbar: "align,40" })); a.on("dirChanged", l)
                }
            }
        })
    ...
    CKEDITOR.tools.buildTableMap = function (q, r, B, v, w) { q = q.$.rows; B = B || 0; v = "number" === typeof v ? v : q.length - 1; w = "number" === typeof w ? w : -1; var u = -1, y = []; for (r = r || 0; r <= v; r++) { u++; !y[u] && (y[u] = []); for (var t = -1, z = B; z <= (-1 === w ? q[r].cells.length - 1 : w); z++) { var p = q[r].cells[z]; if (!p) break; for (t++; y[u][t];)t++; for (var A = isNaN(p.colSpan) ? 1 : p.colSpan, p = isNaN(p.rowSpan) ? 1 : p.rowSpan, x = 0; x < p && !(r + x > v); x++) { y[u + x] || (y[u + x] = []); for (var C = 0; C < A; C++)y[u + x][t + C] = q[r].cells[z] } t += A - 1; if (-1 !== w && t >= w) break } } return y }; (function () {
        ...
        }; CKEDITOR.plugins.tableselection =
        {
            ...
            requires: "clipboard,tabletools", isSupportedEnvironment: function () { return !(CKEDITOR.env.ie && 11 > CKEDITOR.env.version) }, onLoad: function () {
                y = CKEDITOR.plugins.tabletools; v = y.getSelectedCells; C = y.getCellColIndex; F = y.insertRow; G = y.insertColumn;
                ...
                this.isSupportedEnvironment() && (a.addContentsCss && a.addContentsCss(this.path + "styles/tableselection.css"), a.on("contentDom", function () {
                    var b = a.editable(), c = b.isInline() ? b : a.document, d = { editor: a }; b.attachListener(c, "mousedown", w, null, d); b.attachListener(c, "mousemove", w, null, d); b.attachListener(c, "mouseup", w, null, d); b.attachListener(b, "dragstart", M); b.attachListener(a, "selectionCheck", L); CKEDITOR.plugins.tableselection.keyboardIntegration(a);
